<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_date_rdepttype_recppaytype_ruserid_rdate.aspx.cs" Inherits="Saving.Criteria.u_cri_date_rdepttype_recppaytype_ruserid_rdate" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center" style="width:500px">
             <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_branchid_rdepttype_rddate_recppaytype_userid"
