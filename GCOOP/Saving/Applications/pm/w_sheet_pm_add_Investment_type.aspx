<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_pm_add_Investment_type.aspx.cs" Inherits="Saving.Applications.pm.w_sheet_pm_add_Investment_type" %>
...
//            if (name == "b_delete") {
//                var detail = "รหัสประเภท :" + objdw_main.GetItem(row, "investtype_code");
