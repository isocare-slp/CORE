<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_add_investment_type.aspx.cs" Inherits="Saving.Applications.pm.dlg.w_dlg_add_investment_type" %>
    ...
    <script type="text/javascript">
        ...
        function DialogLoadComplete() {
            if (Gcoop.GetEl("HdResult").value == "True") {
                parent.ReTurnOfInvestType(Gcoop.GetEl("HdValue").value)
                parent.RemoveIFrame();
            }
        }
...
<body>
    ...
    &nbsp;&nbsp;เพิ่มประเภทเงินลงทุน
    <br/>
    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_investtype"
