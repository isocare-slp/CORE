<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_add_invsource.aspx.cs"
    Inherits="Saving.Applications.pm.dlg.w_dlg_add_invsource" %>
...
<body>
    ...
    &nbsp;&nbsp;เพิ่มกิจการลงทุน
    <br/>
    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_investsource"
