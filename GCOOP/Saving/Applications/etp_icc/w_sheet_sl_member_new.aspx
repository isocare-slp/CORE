<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_member_new.aspx.cs" Inherits="Saving.Applications.etp_icc.w_sheet_sl_member_new" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function MenubarOpen() {
            Gcoop.OpenDlg("580", "720", "w_dlg_sl_member_new_search.aspx", "")
        }
        function Validate() {
            var result = false;
            result = ValidateForm();
        ...
        function ValidateForm() {
            ...
            if (member_type == 1) {
               // if (salary_amount == "" || salary_amount == null >>> Rm Breaking
...
//        }
        ...
        function itemChange(sender, rowNumber, columnName, newValue) {
            ...
            else if (columnName == "memb_name" || columnName == "memb_surname") {
                
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();

                var mem_name = objdw_main.GetItem(1, "memb_name");
                var mem_surname = objdw_main.GetItem(1, "memb_surname");


                if ((mem_name != null && mem_surname != null) && (mem_name != "" && mem_surname != "")) {
                        jsCheckName();
                    } 
            }
        ...
        function ChangedValue(s, r, c, v) {
            ...
            if (c == "periodshare_value") {
                ...
                if (v % 10 != 0) {
                    ...
                    alert("มูลค่าหุ้นมาตรฐานไม่ต่ำกว่า 10 หุ้น");
                    jsChanegValue();
                }
                else if (v > 20000) {
                     alert("มูลค่าหุ้นมาตรฐานไม่เกิน 2000 หุ้น");
                    jsChanegValue();
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_main" runat="server" ClientScriptable="True" DataWindowObject="d_sl_reqapplmain_design2"
        LibraryList="~/DataWindow/etp_icc/sl_member_new.pbl" ClientEventItemChanged="itemChange"
        ...
        <tr>
            <td valign="top" style="width: 40%;">
                ...
                <dw:WebDataWindowControl ID="dw_data" runat="server" DataWindowObject="d_sl_reqapplshare"
                    LibraryList="~/DataWindow/etp_icc/sl_member_new.pbl" ClientScriptable="True" AutoRestoreContext="False"
    ...
    <dw:WebDataWindowControl ID="dw_gain" runat="server" ClientScriptable="True" DataWindowObject="d_mb_gain_detail_mbnew"
        LibraryList="~/DataWindow/etp_icc/sl_member_new.pbl" AutoRestoreContext="False"
