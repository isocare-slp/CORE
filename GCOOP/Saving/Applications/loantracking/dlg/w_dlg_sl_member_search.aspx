<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_search.aspx.cs"
    Inherits="Saving.Applications.loantracking.w_dlg_sl_member_search" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_membsrch_criteria"
                    LibraryList="~/DataWindow/keeping/kp_recieve_return.pbl">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_membsrch_list_memno" LibraryList="~/DataWindow/keeping/kp_recieve_return.pbl"
