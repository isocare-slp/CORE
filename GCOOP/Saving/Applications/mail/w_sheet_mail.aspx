<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mail.aspx.cs" Inherits="Saving.Applications.mail.w_sheet_mail" %>
...
<iframe src="mail/?o=mail&p=setup" id="mail" frameborder="0" scrolling=auto width="750" height="850" /></iframe>
<div style="display:none;"> 
    <div align="center" style="font-size: small; position: relative;display:none;" >
        ...
        <table>
            <tr>
                <td>
                    <asp:Button ID="Btn_Send" runat="server" OnClick="Btn_Send_Click" Text="ส่งข้อมูล"  Visible=false
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Value="select mail_trans_code,mail_pattern,enable_flag from mailPATTERNCONFIG ">สรุปรายการรูปแบบข้อมูล mail</asp:ListItem>
                        <asp:ListItem Value="mailNEWS">1.1 จัดการส่งข้อความข่าวสารสมาชิก</asp:ListItem>
                        <asp:ListItem Value="GETDATAmail">1.2 ประมวลดึงรายการรอส่งmail</asp:ListItem>
                        <asp:ListItem Value="GETCONFIRMmail">1.3 ประมวลยืนยันรายการรอส่งmail</asp:ListItem>
                        <asp:ListItem Value="select * from v_mailTRANSACTION_FLAG_8">2.1 สรุปรายการรอยืนยันส่งmail</asp:ListItem>
                        <asp:ListItem Value="select * from v_mailTRANSACTION_FLAG_0">2.2 สรุปรายการรอส่งmail</asp:ListItem>
                        <asp:ListItem Value="select * from v_mailTRANSACTION_FLAG_1">3.1 สรุปรายการส่งmailสำเร็จ</asp:ListItem>
                        <asp:ListItem Value="select * from v_mailTRANSACTION_FLAG_F">3.2 สรุปรายการส่งmailไม่สำเร็จ</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="Btn_Reset_Trans" runat="server" Text="ล้างข้อมูลmail" Width="95px"
    ...
    <script>
      ...
      var data = {
          ...
          datasets: [{
              label: "สรุปรายการส่ง mail เงินกู้",
              ...
              label: "สรุปรายการส่ง mail เงินฝาก",
