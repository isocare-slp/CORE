<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_entry_employee_expr.aspx.cs"
    Inherits="Saving.Applications.hr.w_sheet_hr_entry_employee_expr" Title="ประสบการณ์การทำงาน"
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style6" colspan="2">
                <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_hr_employee_head_expr"
                    LibraryList="~/DataWindow/hr/hr_entry_employee_expr.pbl" AutoSaveDataCacheAfterRetrieve="True"
        ...
        <tr class="style5">
            <td class="style9">
                ข้อมูลประสบการณ์เจ้าหน้าที่
            </td>
            <td>
                <b>รายละเอียดข้อมูลประสบการณ์เจ้าหน้าที่
            </b>
            </td>
        </tr>
        <tr class="style5">
            <td class="style7" valign="top">
                <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="dw_hr_employee_expr_list"
                    LibraryList="~/DataWindow/hr/hr_entry_employee_expr.pbl" AutoSaveDataCacheAfterRetrieve="True"
            ...
            <td valign="top">
                <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="dw_hr_employee_expr_detail"
                    LibraryList="~/DataWindow/hr/hr_entry_employee_expr.pbl" Width="420px" Height="300px"
                    HorizontalScrollBar="Auto" AutoSaveDataCacheAfterRetrieve="True" AutoRestoreDataCache="True"
                    AutoRestoreContext="False" ClientScriptable="true" ClientEventButtonClicked="OnDwDetailButtonClick">
                </dw:WebDataWindowControl>
            </td>
        </tr>
        <tr class="style5">
