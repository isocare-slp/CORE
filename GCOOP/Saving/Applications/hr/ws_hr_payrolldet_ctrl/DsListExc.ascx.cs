...
{
    public partial class DsListExc : DataSourceRepeater
    {
        public DataSet1.DT_ListExcDataTable DATA { get; set; }

        public void InitDsListExc(PageWeb pw)
        {
            css1.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.DT_ListExc;
            this.EventItemChanged = "OnDsListExcItemChanged";
            this.EventClicked = "OnDsListExcClicked";
            this.InitDataSource(pw, Repeater1, this.DATA, "dsListExc");
            this.Register();
        }
