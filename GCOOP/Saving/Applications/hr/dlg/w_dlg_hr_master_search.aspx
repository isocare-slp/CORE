<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_hr_master_search.aspx.cs" Inherits="Saving.Applications.hr.dlg.w_dlg_hr_master_search" %>
    ...
    <script type="text/javascript">
        function OnDetailClick(sender, rowNumber, objectName) {
            ...
            window.close();
                ...
                //var isConfirm;
//            isConfirm = confirm("ต้องการเลือก : " + emplid + " " + emplfirsname + "  ใช่หรือไม่");
//            if(isConfirm){
            ...
            <tr>
                <td valign="top" width="600" class="style1">
                    <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" 
                        ...
                        VerticalScrollBar="NoneAndClip" Width="630px" Height="90px">
