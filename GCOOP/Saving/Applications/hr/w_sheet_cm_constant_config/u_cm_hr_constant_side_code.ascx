<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_side_code.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_side_code" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objDwMain.GetItem(row, "deptid");
