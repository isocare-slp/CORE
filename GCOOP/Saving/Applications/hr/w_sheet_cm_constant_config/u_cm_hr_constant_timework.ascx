<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_timework.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_timework" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objDwMain.GetItem(row, "wtime_id");
                detail += " : " + objDwMain.GetItem(row, "wtime_desc");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" BorderStyle="Solid" BorderWidth="0px"
    ClientScriptable="True" DataWindowObject="dw_hr_config_timework" LibraryList="~/DataWindow/hr/hr_constant.pbl"
