<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_law.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_law" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "รหัส " + objDwMain.GetItem(row, "seq_law");
                detail += " : " + objDwMain.GetItem(row, "name_law");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" BorderStyle="Solid" BorderWidth="0px"
    ClientScriptable="True" DataWindowObject="dw_hr_config_law" LibraryList="~/DataWindow/hr/hr_constant.pbl"
