<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_workday_code.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_workday_code" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if (name == "b_delete") {
                var detail = "รหัสตำแหน่ง " + objDwMain.GetItem(row, "posiwid");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" BorderStyle="Solid" BorderWidth="0px"
    ClientScriptable="True" DataWindowObject="dw_hr_config_position_w" LibraryList="~/DataWindow/hr/hr_constant.pbl"
