<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_child.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_child" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" BorderStyle="Solid" BorderWidth="0px"
    ClientScriptable="True" DataWindowObject="dw_hr_config_child" LibraryList="~/DataWindow/hr/hr_constant.pbl"
