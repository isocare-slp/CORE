<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_hr_constant_taxrate.ascx.cs" Inherits="Saving.Applications.hr.u_cm_hr_constant_taxrate" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if(name == "b_delete"){
                var detail = "ปี : " + objDwMain.GetItem(row, "taxyear");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" BorderStyle="Solid" BorderWidth="0px"
    ClientScriptable="True" DataWindowObject="dw_hr_config_taxrate" LibraryList="~/DataWindow/hr/hr_constant.pbl"
