<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_penaltydea.aspx.cs" Inherits="Saving.Applications.hr.w_sheet_hr_penaltydea" Title="ประวัติการรับโทษ" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        ...
        function OnButtonClicked(s, row, oName){
            if(oName == "b_search"){
                ...
                detail += " : " + seq_no + " " + objDwList.GetItem(row, "penalty_date");
        ...
        <tr>
            <td colspan="3">
                ...
                <dw:WebDataWindowControl ID="DwMain" runat="server" 
                    DataWindowObject="dw_hr_penalty_head" 
                    LibraryList="~/DataWindow/hr/hr_penalty.pbl"
        ...
        <tr>
            <td class="style3" valign=top>
                ...
                <dw:WebDataWindowControl ID="DwList" runat="server" 
                    DataWindowObject="dw_hr_penalty_list" 
                    LibraryList="~/DataWindow/hr/hr_penalty.pbl"
                    AutoSaveDataCacheAfterRetrieve="True"
            AutoRestoreDataCache="True"  
            AutoRestoreContext="False" 
            ...
            <td valign=top>
                ...
                <dw:WebDataWindowControl ID="DwDetail" runat="server" 
                    DataWindowObject="dw_hr_penalty_detail" 
                    LibraryList="~/DataWindow/hr/hr_penalty.pbl"
