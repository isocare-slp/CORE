<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsFamily_Hos.ascx.cs" Inherits="Saving.Applications.hr.ws_hr_master_ctrl.DsFamily_Hos" %>
<link id="css1" runat="server" href="../../../JsCss/DataSourceTool.css" rel="stylesheet"
    type="text/css" />
<asp:Panel ID="Panel2" runat="server">
    <div align="right">
        <span id="Span4" class="NewRowLink" onclick="PostInsertRowFamily_Hos()" runat="server">เพิ่มแถว</span>
    </div>
