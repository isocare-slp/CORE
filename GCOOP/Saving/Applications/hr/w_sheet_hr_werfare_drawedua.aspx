<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_werfare_drawedua.aspx.cs"
    Inherits="Saving.Applications.hr.w_sheet_hr_werfare_drawedua" Title="ประวัติการเบิกค่ารักษาพยาบาล"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td valign="top" class="style6">
                <b>ข้อมูลการเบิกค่าเล่าเรียนบุตร</b>
            </td>
            <td valign="top" class="style6">
                <b>รายละเอียดการเบิกค่าเล่าเรียนบุตร</b>
            </td>
        </tr>
        <tr>
            <td class="style5" valign="top">
                <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="dw_hr_werfare_drawedua_detail"
                    LibraryList="~/DataWindow/hr/hr_werfare.pbl" AutoSaveDataCacheAfterRetrieve="True"
                    AutoRestoreDataCache="True" AutoRestoreContext="False" ClientScriptable="True"
            ...
            <td valign="top">
                <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="dw_hr_werfare_drawedua_mas"
