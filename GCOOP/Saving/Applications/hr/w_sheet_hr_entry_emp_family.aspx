<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_entry_emp_family.aspx.cs"
    Inherits="Saving.Applications.hr.w_sheet_hr_entry_emp_family" Title="ประวัติครอบครัว"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwDetailItemChange(s, r, c, v) {
            if (c == "birthdate_tdate") {

                objDwDetail.SetItem(1, "birthdate_tdate", v);
                objDwDetail.AcceptText();
               
                objDwDetail.SetItem(1, "birthdate", Gcoop.ToEngDate(v));
                objDwDetail.AcceptText();
            }
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td valign="top" class="style6">
                <b>ข้อมูลประวัติครอบครัว</b>
            </td>
            <td valign="top" class="style6">
                <b>รายละเอียดประวัติครอบครัวเจ้าหน้าที่</b>
            </td>
        </tr>
        <tr>
            <td class="style5" valign="top">
                <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="dw_hr_employee_family_list"
                    LibraryList="~/DataWindow/hr/hr_entry_emp_family.pbl" AutoSaveDataCacheAfterRetrieve="True"
                    AutoRestoreDataCache="True" AutoRestoreContext="False" ClientScriptable="True"
                    ClientEventClicked="OnListClick" Width="300px">
                </dw:WebDataWindowControl>
            ...
            <td valign="top">
                <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="dw_hr_employee_family_detail"
                    LibraryList="~/DataWindow/hr/hr_entry_emp_family.pbl" Width="400px" Height="250px"
                    AutoSaveDataCacheAfterRetrieve="True" AutoRestoreDataCache="True" AutoRestoreContext="False"
                    ClientScriptable="true" ClientEventButtonClicked="OnDwDetailButtonClick" ClientEventItemChanged="OnDwDetailItemChange" ClientFormatting="True">
                </dw:WebDataWindowControl>
            </td>
        </tr>
        <tr>
