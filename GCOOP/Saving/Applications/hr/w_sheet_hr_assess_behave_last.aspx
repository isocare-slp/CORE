<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_assess_behave_last.aspx.cs" Inherits="Saving.Applications.hr.w_sheet_hr_assess_behave_last" Title="Untitled Page" %>
        ...
        <tr>
            <td style="width: 100%;">
                ...
                <dw:WebDataWindowControl ID="DwMain" runat="server" 
                    DataWindowObject="dw_hr_assess_head" 
                    LibraryList="~/DataWindow/hr/hr_assess_behave_last.pbl"
    ...
    <table style="width: 100%;">
        <tr>
            <td valign=top style="width: 100%;" >
                &nbsp;
                <asp:Label ID="Label3" runat="server" Text="รายละเอียดการประเมินเจ้าหน้าที่" 
                    Font-Bold="True" Font-Names="tahoma" Font-Size="12px"></asp:Label>
                <dw:WebDataWindowControl ID="DwDetail" runat="server" 
                    DataWindowObject="dw_hr_assess_detail" 
                    LibraryList="~/DataWindow/hr/hr_assess_behave_last.pbl"
                    Width="740px" Height="100%" HorizontalScrollBar=Auto
                    AutoSaveDataCacheAfterRetrieve="True"
            AutoRestoreDataCache="True"  
