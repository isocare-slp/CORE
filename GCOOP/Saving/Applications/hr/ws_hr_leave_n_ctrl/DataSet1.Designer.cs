    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class HREMPLOYEERow : global::System.Data.DataRow {
            ...
            public string DEPTLINE_DESC {
                get {
                    try {
                        return ((string)(this[this.tableHREMPLOYEE.DEPTLINE_DESCColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'DEPTLINE_DESC\' in table \'HREMPLOYEE\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableHREMPLOYEE.DEPTLINE_DESCColumn] = value;
                }
            }
            ...
            public bool IsDEPTLINE_DESCNull() {
                return this.IsNull(this.tableHREMPLOYEE.DEPTLINE_DESCColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetDEPTLINE_DESCNull() {
                this[this.tableHREMPLOYEE.DEPTLINE_DESCColumn] = global::System.Convert.DBNull;
            }
...
namespace Saving.Applications.hr.ws_hr_leave_n_ctrl.DataSet1TableAdapters {
...
WHERE        HRLOGLEAVE.LEAVE_CODE = HRUCFLEAVECODE.LEAVE_CODE";
    ...
    public partial class HREMPLOYEETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OracleClient.OracleCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        HREMPLOYEE.COOP_ID, HREMPLOYEE.EMP_NO, HREMPLOYEE.PRENAME_CODE, HRE" +
                "MPLOYEE.EMP_NAME, HREMPLOYEE.EMP_SURNAME, HREMPLOYEE.EMP_ENAME, HREMPLOYEE.EMP_E" +
                "SURNAME, \r\n                         HREMPLOYEE.EMP_NICKNAME, HREMPLOYEE.EMPTYPE_" +
                "CODE, HREMPLOYEE.DEPTGRP_CODE, HREMPLOYEE.POS_CODE, HREMPLOYEE.SEX, HREMPLOYEE.B" +
                "LOOD_GRP, HREMPLOYEE.WEIGHT, \r\n                         HREMPLOYEE.HEIGHT, HREMP" +
                "LOYEE.NATION, HREMPLOYEE.RELIGION, HREMPLOYEE.ADN_NO, HREMPLOYEE.ADN_TAMBOL, HRE" +
                "MPLOYEE.ADN_AMPHUR, HREMPLOYEE.ADN_PROVINCE, \r\n                         HREMPLOY" +
                "EE.ADN_POSTCODE, HREMPLOYEE.ADN_TEL, HREMPLOYEE.ADN_EMAIL, HREMPLOYEE.ADR_NO, HR" +
                "EMPLOYEE.ADR_TAMBOL, HREMPLOYEE.ADR_AMPHUR, HREMPLOYEE.ADR_PROVINCE, \r\n         " +
                "                HREMPLOYEE.ADR_POSTCODE, HREMPLOYEE.ID_CARD, HREMPLOYEE.BIRTH_DA" +
                "TE, HREMPLOYEE.WORK_DATE, HREMPLOYEE.RESIGN_DATE, HREMPLOYEE.CONTAIN_DATE, HREMP" +
                "LOYEE.TERM_DATE, \r\n                         HREMPLOYEE.SALARY_ID, HREMPLOYEE.SAL" +
                "ARY_AMT, HREMPLOYEE.SALEXP_CODE, HREMPLOYEE.SALEXP_BANK, HREMPLOYEE.SALEXP_BRANC" +
                "H, HREMPLOYEE.SALEXP_ACCID, \r\n                         HREMPLOYEE.TAX_CALCODE, H" +
                "REMPLOYEE.TAX_BFAMT, HREMPLOYEE.SS_STATUS, HREMPLOYEE.SS_APPFIRSTSTS, HREMPLOYEE" +
                ".SS_BFAMT, HREMPLOYEE.SS_APPDATE, HREMPLOYEE.SS_RATE, \r\n                        " +
                " HREMPLOYEE.SS_HOSPITAL, HREMPLOYEE.PROVF_STATUS, HREMPLOYEE.PROVF_CORPRATE, HRE" +
                "MPLOYEE.PROVF_EMPRATE, HREMPLOYEE.PROVF_APPDATE, HREMPLOYEE.PROVF_RESIGNDATE, \r\n" +
                "                         HREMPLOYEE.PROVF_BFAMT, HREMPLOYEE.REF_MEMBNO, HREMPLOY" +
                "EE.EMP_STATUS, MBUCFPRENAME.PRENAME_DESC, HRUCFDEPTGRP.DEPTGRP_DESC, HRUCFDEPTLI" +
                "NE.DEPTLINE_DESC, \r\n                         HRUCFPOSITION.POS_DESC\r\nFROM       " +
                "     MBUCFPRENAME, HREMPLOYEE, HRUCFDEPTGRP, HRUCFDEPTLINE, HRUCFPOSITION\r\nWHERE" +
                "        MBUCFPRENAME.PRENAME_CODE = HREMPLOYEE.PRENAME_CODE AND HREMPLOYEE.DEPTG" +
                "RP_CODE = HRUCFDEPTGRP.DEPTGRP_CODE AND \r\n                         HRUCFDEPTGRP." +
                "DEPTLINE_CODE = HRUCFDEPTLINE.DEPTLINE_CODE AND HREMPLOYEE.POS_CODE = HRUCFPOSIT" +
                "ION.POS_CODE";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
