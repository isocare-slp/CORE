<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.hr.ws_hr_constant_ucfposition_ctrl.DsList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="10%">
                        <asp:TextBox ID="pos_code" runat="server" Style="text-align: center;"></asp:TextBox>
                    </td>
                    <td width="40%">
                        <asp:TextBox ID="pos_desc" runat="server"></asp:TextBox>
                    </td>
                    <td width="40%">
                        <asp:TextBox ID="pos_money" runat="server" Style="text-align: right;" ToolTip="#,##0.00"></asp:TextBox>
                    </td>
                    <td width="5%">
