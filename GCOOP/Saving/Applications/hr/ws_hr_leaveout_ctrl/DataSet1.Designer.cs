...
namespace Saving.Applications.hr.ws_hr_leaveout_ctrl.DataSet1TableAdapters {
    ...
    public partial class HRLOGLEAVETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.OracleClient.OracleCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO ""ISCOGSB"".""HRLOGLEAVE"" (""COOP_ID"", ""EMP_NO"", ""SEQ_NO"", ""OPERATE_DATE"", ""LEAVE_CODE"", ""LEAVE_FROM"", ""LEAVE_TO"", ""TOTALTIME"", ""LEAVE_CAUSE"", ""LEAVE_TEL"", ""LEAVE_PLACE"", ""APV_STATUS"", ""APV_DATE"", ""APV_REMARK"", ""APV_BYCODE"", ""START_TIME"", ""LAST_TIME"", ""TOTALDAY"") VALUES (:COOP_ID, :EMP_NO, :SEQ_NO, :OPERATE_DATE, :LEAVE_CODE, :LEAVE_FROM, :LEAVE_TO, :TOTALTIME, :LEAVE_CAUSE, :LEAVE_TEL, :LEAVE_PLACE, :APV_STATUS, :APV_DATE, :APV_REMARK, :APV_BYCODE, :START_TIME, :LAST_TIME, :TOTALDAY)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("COOP_ID", global::System.Data.OracleClient.OracleType.Char, 0, global::System.Data.ParameterDirection.Input, "COOP_ID", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("EMP_NO", global::System.Data.OracleClient.OracleType.Char, 0, global::System.Data.ParameterDirection.Input, "EMP_NO", global::System.Data.DataRowVersion.Current, false, null));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT COOP_ID, EMP_NO, SEQ_NO, OPERATE_DATE, LEAVE_CODE, LEAVE_FROM, LEAVE_TO, T" +
                "OTALTIME, LEAVE_CAUSE, LEAVE_TEL, LEAVE_PLACE, APV_STATUS, APV_DATE, APV_REMARK," +
                " APV_BYCODE, START_TIME, LAST_TIME, TOTALDAY FROM ISCOGSB.HRLOGLEAVE";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Insert(
            ...
            if ((TOTALTIME.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((decimal)(TOTALTIME.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[7].Value = global::System.DBNull.Value;
            }
            if ((LEAVE_CAUSE == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(LEAVE_CAUSE));
            }
            if ((LEAVE_TEL == null)) {
                this.Adapter.InsertCommand.Parameters[9].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(LEAVE_TEL));
            }
            if ((LEAVE_PLACE == null)) {
                this.Adapter.InsertCommand.Parameters[10].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[10].Value = ((string)(LEAVE_PLACE));
            }
            if ((APV_STATUS.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[11].Value = ((decimal)(APV_STATUS.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[11].Value = global::System.DBNull.Value;
            }
            if ((APV_DATE.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[12].Value = ((System.DateTime)(APV_DATE.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            if ((APV_REMARK == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[13].Value = ((string)(APV_REMARK));
            }
            if ((APV_BYCODE == null)) {
                this.Adapter.InsertCommand.Parameters[14].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[14].Value = ((string)(APV_BYCODE));
            }
            if ((START_TIME == null)) {
                this.Adapter.InsertCommand.Parameters[15].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[15].Value = ((string)(START_TIME));
            }
            if ((LAST_TIME == null)) {
                this.Adapter.InsertCommand.Parameters[16].Value = global::System.DBNull.Value;
            }
            ...
            if ((TOTALDAY.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[17].Value = ((decimal)(TOTALDAY.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[17].Value = global::System.DBNull.Value;
            }
