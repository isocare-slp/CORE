<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.hr.ws_hr_apv_leave_ctrl.DsMain" %>
...
<asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
    <table class="DataSourceRepeater">
        <tr>
            ...
            <th width="5%" style="background-color: #00FF00">
            </th>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="5%">
                        <div>
                            <asp:Button ID="b_apv" runat="server" Text="อนุมัติ" Style="background-color: #DDDDDD;">
                            </asp:Button></div>
                    </td>
                    <td width="5%">
                        <div>
                            <asp:Button ID="b_apv_cancel" runat="server" Text="ไม่อนุมัติ" Style="background-color: #DDDDDD;">
                            </asp:Button></div>
                    </td>
                </tr>
            </ItemTemplate>
