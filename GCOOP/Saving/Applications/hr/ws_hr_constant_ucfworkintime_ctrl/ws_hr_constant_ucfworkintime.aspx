<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_hr_constant_ucfworkintime.aspx.cs" Inherits="Saving.Applications.hr.ws_hr_constant_ucfworkintime_ctrl.ws_hr_constant_ucfworkintime" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div>
        <uc1:DsList ID="dsList" runat="server" /></div>
</asp:Content>
