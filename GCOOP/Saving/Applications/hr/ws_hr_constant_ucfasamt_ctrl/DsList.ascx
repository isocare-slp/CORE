...
Inherits="Saving.Applications.hr.ws_hr_constant_ucfasamt_ctrl.DsList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="10%">
                        <asp:TextBox ID="as_code" runat="server" Style="text-align: center;"></asp:TextBox>
                    </td>
                    <td width="25%">
                    ...
                    <td width="25%">
                        <asp:TextBox ID="as_amt" runat="server" Style="text-align: right" ToolTip="#,##0.00"></asp:TextBox>
                    </td>
                    <td width="5%">
