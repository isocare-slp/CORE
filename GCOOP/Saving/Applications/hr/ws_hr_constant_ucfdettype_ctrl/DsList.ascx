<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.hr.ws_hr_constant_ucfdettype_ctrl.DsList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="10%">
                        <asp:TextBox ID="emptype_code" runat="server" Style="text-align: center;"></asp:TextBox>
                    </td>
                    <td width="80%">
                        <asp:TextBox ID="emptype_desc" runat="server"></asp:TextBox>
                    </td>
                    <td width="5%">
