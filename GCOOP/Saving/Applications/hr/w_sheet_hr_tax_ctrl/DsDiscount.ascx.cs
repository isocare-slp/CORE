...
{
    public partial class DsDiscount : DataSourceFormView
    {
        ...
        public void InitDs(PageWeb pw)
        {
            ...
            this.InitDataSource(pw, FormView1, this.DATA, "dsDiscount");
            this.EventItemChanged = "OnDsDiscountItemChanged";
            this.Register();
        ...
        public void RetreiveEmplid(String emplid, String year, int month)
        {
           ...
           select sum(case when hrnpayroll_taxset.seq_tax = 'A01' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A01
                ...
                ,sum(case when hrnpayroll_taxset.seq_tax = 'A17' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A17
				,sum(case when hrnpayroll_taxset.seq_tax = 'A18' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A18
                ,sum(case when hrnpayroll_taxset.seq_tax = 'A21' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A21
                ,sum(case when hrnpayroll_taxset.seq_tax = 'A22' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A22
                ,sum(case when hrnpayroll_taxset.seq_tax = 'A23' AND   hrnpayroll_taxset.taxlist1_amt is not null  then hrnpayroll_taxset.taxlist1_amt  else 0 end) as A23
            from
            ...
            and hrnpayroll_taxset.pay_year = '" + year_pay + "' and hrnpayroll_taxset.pay_month = '1' and HRNMLEMPLFILEMAS.emplcode = '" + emplid + @"'
