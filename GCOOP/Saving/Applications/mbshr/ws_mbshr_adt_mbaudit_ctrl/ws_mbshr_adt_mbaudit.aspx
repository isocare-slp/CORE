    ...
    <script type="text/javascript">
        ...
        function OnDsListClicked(s, r, c, v) {
            if (c == "b_del") {
                ...
                dsList.SetRowFocus(r);
                var memberNo = dsMain.GetItem(0, "member_no"); 
                //Gcoop.OpenIFrame2FixPathExtend("450", "600", "deposit", "wd_dep_deptaccount_search.aspx", "?member_no=" + memberNo);
                Gcoop.OpenIFrame2Extend("850", "600", "wd_dep_deptaccount_search.aspx", "?member_no=" + memberNo);
            }
        }
        function GetDeptNoMonthint(deptaccount_no) {
            var row = dsList.GetRowFocus();
            dsList.SetItem(row, "bank_accid", deptaccount_no);    
        }
