<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_adt_mbaudit_ctrl.DsList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td width="20%">
                        <asp:TextBox ID="bank_accid" runat="server" Style="text-align: center;width:77%"></asp:TextBox>
                        <asp:Button ID="b_deptno" runat="server" Text="..."  Width="15%" />
                    </td>
                    <td width="5%">
