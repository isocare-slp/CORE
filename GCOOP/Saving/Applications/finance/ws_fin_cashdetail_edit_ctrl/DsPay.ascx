<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsPay.ascx.cs" Inherits="Saving.Applications.finance.ws_fin_cashdetail_edit_ctrl.DsPay" %>
<link id="css1" runat="server" href="../../../JsCss/DataSourceTool.css" rel="stylesheet"
    type="text/css" />
<asp:Panel ID="Panel1" runat="server" Height="450px" ScrollBars="Auto" HorizontalAlign="Left">    
    <table class="DataSourceRepeater"   style="width:355px">
        <tr>
		<th>                                
            </th>
            <th>  
        ...
        <asp:Repeater ID="Repeater1"  runat="server">
			...
			<asp:CheckBox ID="AI_PAY" runat="server" ></asp:CheckBox>
                    </td>
                    <td width="3%" style="border: 0px;">
