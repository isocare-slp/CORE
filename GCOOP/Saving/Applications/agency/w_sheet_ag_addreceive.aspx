<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_ag_addreceive.aspx.cs"
    Inherits="Saving.Applications.agency.w_sheet_ag_addreceive" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DetailChanged(sender, rowNumber, columnName, newValue) {
            if (columnName == "addrecv_amt") {
                objdw_detail.SetItem(rowNumber, columnName, newValue);
                objdw_detail.AcceptText();
                Gcoop.GetEl("Hcolumnname").value = columnName;
                var recv_amt = Gcoop.ParseFloat(objdw_detail.GetItem(rowNumber, "addrecv_amt")) + 0;
                ...
                objdw_detail.SetItem(rowNumber, columnName, newValue);
                objdw_detail.AcceptText();
                Gcoop.GetEl("Hexpense_bank").value = newValue;
                jsPostbank();
            }
        }
        function MenubarNew() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="Hexpense_bank" runat="server" />
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td rowspan="2" valign="top">
                <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_agentsrv_initaddreceive_detail"
                    LibraryList="~/DataWindow/agency/agent.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
