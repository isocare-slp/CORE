<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_member_search.aspx.cs" Inherits="Saving.Applications.agency.dlg.w_dlg_member_search" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_membsrch_criteria"
                    LibraryList="~/DataWindow/keeping/sl_member_search.pbl">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        ...
        RowsPerPage="17" ClientScriptable="True" AutoRestoreContext="False" 
