<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_mis_export_pension2.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_mis_export_pension2" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td class="style1" colspan="2">
                <strong>เลือกช่วงเวลาที่อนุมัติจ่ายทุน</strong>
            </td>
        </tr>
        <tr>
            <td class="style1">
        ...
        <tr>
            <td class="style1">
                <strong>ข้อมูลรายละเอียดกองทุนสวัสดิการบำนาญ แบบที่2</strong>
            </td>
        </tr>
        <tr>
            <td>
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_export_egat_sms_request_pension2"
                    LibraryList="~/DataWindow/mis/smsobjects.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
