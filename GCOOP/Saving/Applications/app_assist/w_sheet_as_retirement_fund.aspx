<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_retirement_fund.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_retirement_fund" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (member_no != null && capital_year != null && assist_amt != null && req_date != null && member_age != null) {
        ...
        function MenubarOpen() {
            Gcoop.OpenDlg(580, 600, "w_dlg_as_retirement_fund_list.aspx", "");
        }
        ...
        function DwDetailItemChange(sender, rowNumber, columnName, newValue) {
            if (columnName == "retire_tdate") {
                objDwDetail.SetItem(rowNumber, columnName, newValue);
                objDwDetail.AcceptText();
                Gcoop.GetEl("HdRetireDate").value = newValue;
                postChangeAmt();
            }
        }
        function Alert() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwDetail" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
        DataWindowObject="d_as_reqretirement" ClientScriptable="True" AutoRestoreContext="false"
        AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
    ...
    <asp:HiddenField ID="HdRetireDate" runat="server" /> 
</asp:Content>
