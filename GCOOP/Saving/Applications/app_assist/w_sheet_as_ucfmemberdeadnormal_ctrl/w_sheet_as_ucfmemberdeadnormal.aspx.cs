...
{
    public partial class w_sheet_as_ucfmemberdeadnormal : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostInsertRow)
            {
                ...
                dsList.DATA[0].ENVCODE = "memberdeadnormal_" + seq_no1;
                dsList.DATA[0].ENVGROUP = "member_dead_normal";
