...
namespace Saving.Applications.app_assist.w_sheet_as_ucfmanagementbodies_ctrl
{
    public partial class w_sheet_as_ucfmanagementbodies : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostInsertRow)
            {
                ...
                dsList.DATA[0].ENVCODE = "managementbodies_" + seq_no1;
                dsList.DATA[0].ENVGROUP = "management_bodies";
        ...
        public Decimal MaxSeqno()
        {
            ...
            try
            {
                String strsql = @" SELECT max(seq_no) as seq_no FROM ASNSENVIRONMENTVAR  
                           WHERE ASNSENVIRONMENTVAR.ENVGROUP = 'management_bodies'";
