<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mis_export_pension1.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_mis_export_pension1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style1">
                <strong>ข้อมูลรายละเอียดกองทุนสวัสดิการบำนาญ แบบที่1</strong>
            </td>
        </tr>
        <tr>
            <td>
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_export_egat_sms_request_pension1"
                    LibraryList="~/DataWindow/mis/smsobjects.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
