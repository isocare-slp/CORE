<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_as_loan_benefit.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_loan_benefit" %>
...
//////////////////////////////////////////////////////////////////////////
    function MenubarOpen() {
        Gcoop.OpenDlg(565, 550, "w_dlg_as_loan_benefit_list.aspx", "");
    }
//////////////////////////////////////////////////////////////////////////
...
//         alert("1");
        ...
        objDwMain.AcceptText();
//        var reqStatus = objDwMain.GetItem(1, "req_status");
...
<dw:webdatawindowcontrol ID="DwMem" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
    ...
    <dw:WebDataWindowControl ID="DwDetail" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
        DataWindowObject="d_as_reqloan_benefit" ClientScriptable="True" AutoRestoreContext="false"
        AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
