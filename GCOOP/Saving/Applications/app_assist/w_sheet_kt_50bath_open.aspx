<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kt_50bath_open.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_kt_50bath_open" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CallPrintBook(slipNo) {
            Gcoop.OpenDlg(600, 300, "w_dlg_dp_printbook.aspx", "");
        }
        ...
        function OnDwMainItemChanged(s, row, c, v) {
            if (c == "deptformat") {
                ...
                postRecpPayTypeCode();
                return 0;
            } else if (c == "deptslip_amt") {
                try {
                    var deptwithFlag = s.GetItem(1, "deptwith_flag");
                    var otherAmt = 0; //s.GetItem(1, "other_amt");
                    try {
        ...
        function ReDlgDeptWith(objDlg, itemType, recpPayType) {
            //alert(objDlg + "   " + itemType + "  " + recpPayType);
//            try {
//                objDlg.close();
//            } catch (Err) { alert("ErrWin"); }
        ...
        function SheetLoadComplete() {
            ...
            if (printFlag == "true") {
                ...
                if (argPrintBook != "") {
                    //PRINTBOOK-DOYS
                    Gcoop.OpenIFrame(430, 240, "w_dlg_dp_printbook.aspx", "?deptAccountNo=" + argPrintBook);
                }
            }
...
//                }
                ...
                //Gcoop.OpenIFrame(600, 450, "w_dlg_deptwith.aspx", "?itemDeptWith=" + "c");
                ReDlgDeptWith("", "/", "CCA");
                return;
            } catch (Err) {
                alert(Err);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" TabIndex="1">
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_dp_kt_slip_master_usebkbal"
            LibraryList="~/DataWindow/app_assist/kt_50bath.pbl" ClientEventButtonClicked="OnButtonClicked"
 ...
 <%--   <br />
    ...
    <asp:Label ID="Label1" runat="server" Text="รายละเอียดต้นเงิน" Font-Bold="True" Font-Names="Tahoma"
        Font-Size="14px" ForeColor="#0099CC" Font-Overline="False" Font-Underline="True" Visible="false" />
    &nbsp; <span onclick="OnClickCalInt()" style="cursor: pointer;">
        <asp:Label ID="Label4" runat="server" Text="คำนวนดอกเบี้ย" Font-Bold="False" Font-Names="Tahoma"
            Font-Size="14px" Font-Underline="True" ForeColor="#006600" Visible="false"  /></span>
    <asp:Panel ID="Panel3" runat="server" Width="740" ScrollBars="Auto" Visible="false">
        <dw:WebDataWindowControl ID="DwItem" runat="server" DataWindowObject="d_dp_kt_slip_item"
        ...
        Font-Size="14px" ForeColor="#0099CC" Font-Overline="False" 
    ...
    <span onclick="OnClickDeleteRowCheque()" style="cursor: pointer;">
        <asp:Label ID="LbDel2" runat="server" Text="ลบแถว" Font-Bold="False" Font-Names="Tahoma"
            Font-Size="14px" Font-Underline="True" ForeColor="Red" 
        Visible="False" /></span>
