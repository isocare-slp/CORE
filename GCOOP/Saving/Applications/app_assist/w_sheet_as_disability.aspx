<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_disability.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_disability" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (member_no != null && capital_year != null && assist_amt != null && req_date != null && hoard_case != null && hoard_tdate != null && member_age != null) {
        ...
        function MenubarOpen() {
            Gcoop.OpenDlg(630, 550, "w_dlg_as_disability_list.aspx", "");
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwDetail" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
        DataWindowObject="d_as_reqhoard" ClientScriptable="True" AutoRestoreContext="false"
        AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
