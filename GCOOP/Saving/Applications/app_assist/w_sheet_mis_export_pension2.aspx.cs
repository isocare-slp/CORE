...
{
    public partial class w_sheet_mis_export_pension2 : PageWebSheet, WebSheet
    {
        DataStore DStore;
        ...
        private void JsButtonShowData()
        {
            ...
            try
            {
                ...
                //DateTime endDate = DateTime.ParseExact(end_tdate, "ddMMyyyy", WebUtil.TH);//Dw_main.GetItemDateTime(1, "end_date");
        ...
        private void SaveFile()
        {
            ...
            if (report_format == "TXT")
            {
                try
                {
                    ...
                    if (astr_rptexcel.as_xmldw != "")
                    {
                        ...
                        String filename = "Pension(2)" + DateTime.Now.ToString("yyyyMMdd") + ".txt";
                        ...
                        DStore.DataWindowObject = "d_export_egat_sms_request_pension2";
                        ...
                        while (i < row + 1)
                        {
                            ...
                            try
                            {
                                g = DStore.GetItemString(i, "method");
                                g = g.Replace("จำกัด", "");
                                g = g.Replace("(มหาชน)", "");
                                g = g.Replace(" ", "");
                            }
                            ...
                            try
                            {
                                h = DStore.GetItemString(i, "asnslippayout_bank_accid");
                            }
                            catch
                            {
                                h = "";
                            ...
                            try
                            {
                                k = DStore.GetItemString(i, "str_date");
                            }
                            catch
                            {
                                k = "";
                            }
                            total = a + "," + b + "," + c + "," + d + "," + e + "," + f + "," + g + "," + h + "," + k;
            ...
            else if (report_format == "XLS")
            {
                try
                {
                    ...
                    {
                        String xml_detail = astr_rptexcel.as_xmldw;
                        String filename = "Pension(2)" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
