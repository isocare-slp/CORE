<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_as_reqdeposit.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_reqdeposit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
      ...
      function MenubarOpen() {
          Gcoop.OpenDlg(530, 500, "w_dlg_as_member_search.aspx", "");
                }
        function CommitPrintFirstPage() {
            var deptAccountNo = Gcoop.GetEl("HdAccoutNo").value;
            Gcoop.OpenIFrame(430, 240, "w_dlg_kt_printbook.aspx", "?deptAccountNo=" + deptAccountNo);
        }
...
//            objDwMain.SetItem(1, "ref_docno", deptSlipNo);
...
//        }
        ...
        function MenubarNew() {
            window.location = Gcoop.GetUrl() + "Applications/app_assist/w_sheet_as_reqdeposit.aspx";
        }
...
//        }
        ...
        function OnDwMainButtonClicked(sender, rowNumber, buttonName) {
            if (buttonName == "b_member") {
                ...
                Gcoop.OpenDlg(485, 489, "w_dlg_as_current_account_no.aspx", "");
            }

            else if (buttonName == "cb_referslip") {
                var recpPayType = objDwMain.GetItem(rowNumber, "recppaytype_code");
                if (recpPayType == "OTR") {
                    Gcoop.OpenDlg(650, 600, "w_dlg_dp_slip_search_tran.aspx", "");
                }
            }
        ...
        function SheetLoadComplete() {
            ...
            if (Gcoop.GetEl("HdCheckApvAlert").value == "true") {
                ...
                Gcoop.OpenIFrame(240, 170, "w_dlg_kt_addapv_task.aspx", "?processId=" + processId + "&avpCode=" + avpCode + "&itemType=" + itemType + "&avpAmt=" + avpAmt);
            }
...
<asp:Literal ID="LtServerMessage" runat="server"></asp:Literal>
    <asp:Panel ID="Panel1" runat="server" Width="680px">
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_kt_reqdepoist_main"
            ...
            TabIndex="1" ClientEventButtonClicked="OnDwMainButtonClicked" ClientEventClicked="OnDwMainClick">
...
<%--                <dw:WebDataWindowControl ID="DwGain" runat="server" DataWindowObject="d_dp_reqcodeposit"
                    ...
                    ClientEventClicked="OnDwGainClicked" TabIndex="600">
                </dw:WebDataWindowControl>--%>
<%--            </td>
            <td valign="top">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%--    <dw:WebDataWindowControl ID="DwCheque" runat="server" DataWindowObject="d_cheque_operate_external"
        ...
        ClientScriptable="True" ClientEventClicked="OnDwChequeClick" 
        ClientEventItemChanged="OnDwChequeItemChanged" TabIndex="900">
    </dw:WebDataWindowControl>--%>
