<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_kt_member_search.aspx.cs" 
Inherits="Saving.Applications.app_assist.dlg.w_dlg_kt_member_search" %>
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            if (objectName != "datawindow") {
                ...
                window.opener.GetValueFromDlg(memberno, pre_name, memb_name, memb_surname, membgroup_desc, membgroup_code);
                window.close();
            }
        }
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_dlg_kt_membsrch_criteria"
                    LibraryList="~/DataWindow/app_assist/kt_50bath.pbl" ClientEventItemChanged="ItemChangedDwData">
