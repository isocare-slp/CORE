<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_kt_cancel_slip.aspx.cs" Inherits="Saving.Applications.app_assist.dlg.w_dlg_kt_cancel_slip" %>
            ...
            <td>
                ...
                <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
                        DataWindowObject="d_dlg_cancel_slip_ps" LibraryList="~/DataWindow/app_assist/kt_pension.pbl"
