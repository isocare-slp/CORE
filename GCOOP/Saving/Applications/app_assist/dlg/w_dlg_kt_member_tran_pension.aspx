<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_kt_member_tran_pension.aspx.cs" Inherits="Saving.Applications.app_assist.dlg.w_dlg_kt_member_tran_pension" %>
        ...
        <tr>
            <td class="style1">
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_dlg_kt_membsrch_criteria"
                    ...
                    ClientEventItemChanged="ItemChangedDwData" 
                    style="top: 0px; left: 0px; width: 438px">
                </dw:WebDataWindowControl>
            </td>
            <td>
                <%--<asp:Button ID="cb_find" runat="server" Text="ค้นหา" Height="80px" Width="55px" OnClick="cb_find_Click" />--%>
                <input id="btnSearch" type="button" value="ค้นหา" onclick="OnSearch(this)" style="width: 64px;
                    height: 53px;" />
            </td>
        </tr>
    </table>
