...
{
    public partial class w_dlg_kt_member_search : PageWebDialog, WebDialog
    {
...
//         ( MBMEMBMASTER.SUBGROUP_CODE = MBUCFMBSUBGROUP.SUBGROUP_CODE )";
    ...
    ( MBMEMBMASTER.MEMBGROUP_CODE = MBUCFMEMBGROUP.MEMBGROUP_CODE ) and  
         ( MBMEMBMASTER.PRENAME_CODE = MBUCFPRENAME.PRENAME_CODE ) and  
         ( MBMEMBMASTER.SUBGROUP_CODE = MBUCFMBSUBGROUP.SUBGROUP_CODE ) and
    (ASNREQMASTER.ASSISTTYPE_CODE = 70)";
