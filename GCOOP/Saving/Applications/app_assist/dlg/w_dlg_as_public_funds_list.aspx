<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_as_public_funds_list.aspx.cs"
    Inherits="Saving.Applications.app_assist.dlg.w_dlg_as_public_funds_list" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_main" runat="server" ClientScriptable="True"
                        DataWindowObject="d_as_year_memno_childid" HorizontalScrollBar="NoneAndClip" 
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_as_reqassist_list"
