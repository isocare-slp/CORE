<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_member_dead_normal.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_member_dead_normal" %>
    ...
    <script type="text/javascript">
        ...
        function DwDetailItemChange(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "member_dead_tdate") {
                ...
                postSetBranch();
            } else if (columnName == "member_recieve_type") {
                objDwDetail.AcceptText();
                objDwDetail.SetItem(rowNumber, "member_recieve_type", newValue);
                postSetMateName();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div>
        <dw:WebDataWindowControl ID="DwMem" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
            DataWindowObject="d_as_reqmember_dead" ClientScriptable="True" AutoRestoreContext="false"
    ...
    <div>
        <dw:WebDataWindowControl ID="DwMain" runat="server" LibraryList="~/DataWindow/app_assist/as_capital.pbl"
            DataWindowObject="d_as_reqmaster_dead" ClientScriptable="True" AutoRestoreContext="false"
            AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
