...
{
    public partial class w_sheet_as_ucfscholarships : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostInsertRow)
            {
                ...
                dsList.DATA[0].ENVCODE = "scholarships_" + seq_no1;
                dsList.DATA[0].ENVGROUP = "school";
        ...
        public Decimal MaxSeqno()
        {
            ...
            try
            {
                String strsql = @" SELECT max(seq_no) as seq_no FROM ASNSENVIRONMENTVAR  
                           WHERE ASNSENVIRONMENTVAR.ENVGROUP = 'school'";
