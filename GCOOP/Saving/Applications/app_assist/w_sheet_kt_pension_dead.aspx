<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kt_pension_dead.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_kt_pension_dead" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (member_no != null && assist_amt != null && member_dead_tdate != null && member_age != null) {
        ...
        function DwMainPItemChange(sender, rowNumber, columnName, newValue) {
            ...
            else if (columnName == "asnslippayout_bank_accid") {
                postBankAccid();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server" TabIndex="2">
        <dw:WebDataWindowControl ID="DwReceive" runat="server" LibraryList="~/DataWindow/app_assist/kt_pension.pbl"
        DataWindowObject="d_ps_member_recevie" ClientScriptable="True" AutoRestoreContext="false"
        AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True"
