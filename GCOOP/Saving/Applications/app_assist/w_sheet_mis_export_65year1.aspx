<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_mis_export_65year1.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_mis_export_65year1" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td class="style1" colspan="2">
                <strong>เลือกวันที่จ่ายทุน</strong>
            </td>
        </tr>
        <tr>
            <td class="style1">
        ...
        <tr>
            <td class="style1">
                <strong>ข้อมูลรายละเอียดกองทุนสวัสดิการเงินสะสม 65 ปีมีสุข แบบที่1</strong>
            </td>
        </tr>
        <tr>
            <td>
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_export_egat_sms_request_65y1"
                    LibraryList="~/DataWindow/mis/smsobjects.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
