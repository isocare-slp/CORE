...
{
    public partial class w_sheet_mis_export_65year2 : PageWebSheet, WebSheet
    {
        DataStore DStore;
        ...
        private void SaveFile()
        {
            ...
            if (report_format == "TXT")
            {
                try
                {
                    ...
                    if (astr_rptexcel.as_xmldw != "")
                    {
                        ...
                        String filename = "65Years(2)" + DateTime.Now.ToString("yyyyMMdd") + ".txt";
                        ...
                        DStore.DataWindowObject = "d_export_egat_sms_request_65y2";
            ...
            else if (report_format == "XLS")
            {
                try
                {
                    ...
                    {
                        String xml_detail = astr_rptexcel.as_xmldw;
                        String filename = "65Years(2)" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
