<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_save_payment.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_save_payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table>
        <tr>
            <td>
                <asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="100px" Width="700px">
                    <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_exec_project_course_list"
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Width="810px">
