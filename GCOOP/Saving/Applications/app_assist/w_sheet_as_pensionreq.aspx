<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_as_pensionreq.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_pensionreq" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MenubarNew() {
            window.location = Gcoop.GetUrl() + "Applications/app_assist/w_sheet_as_pensionreq.aspx";
        }
...
<asp:Literal ID="LtServerMessage" runat="server"></asp:Literal>
    <asp:Panel ID="Panel1" runat="server" Width="680px">
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_kt_asnreqmaster"
