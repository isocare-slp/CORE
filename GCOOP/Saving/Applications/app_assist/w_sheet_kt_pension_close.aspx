<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kt_pension_close.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_kt_pension_close" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" TabIndex="1">
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_dp_kt_slip_master_usebkbal"
            LibraryList="~/DataWindow/app_assist/kt_pension.pbl" ClientEventButtonClicked="OnButtonClicked"
 ...
 <%--   <br />
    ...
    <asp:Panel ID="Panel3" runat="server" Width="740" ScrollBars="Auto">
        <dw:WebDataWindowControl ID="DwItem" runat="server" DataWindowObject="d_dp_kt_slip_item"
            LibraryList="~/DataWindow/app_assist/kt_pension.pbl" AutoRestoreContext="False"
