...
namespace Saving.Applications.app_assist.w_sheet_as_ucfenhancequalityoflife_ctrl
{
    public partial class w_sheet_as_ucfenhancequalityoflife : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostInsertRow)
            {
                ...
                dsList.DATA[0].ENVCODE = "enhancequalityoflife_" + seq_no1;
                dsList.DATA[0].ENVGROUP = "enhance_quality_of_life";
        ...
        public Decimal MaxSeqno()
        {
            ...
            try
            {
                String strsql = @" SELECT max(seq_no) as seq_no FROM ASNSENVIRONMENTVAR  
                           WHERE ASNSENVIRONMENTVAR.ENVGROUP = 'enhance_quality_of_life'";
