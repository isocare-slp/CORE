<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_family_dead_pay.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_family_dead_pay" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server" Width="800px" ScrollBars="Auto">
                    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_as_family_pay"
                        LibraryList="~/DataWindow/app_assist/kt_paydead.pbl" AutoRestoreContext="False"
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                        ClientFormatting="True" ClientEventButtonClicked="OnDwMainButtonClick" ClientEventItemChanged="DwMainItemChange">
