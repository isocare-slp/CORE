<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_scholarship_mu_edit.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_scholarship_mu_edit" %>
    ...
    <script type="text/javascript">
        ...
        function DwSchoolItemChange(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "scholarship_type" || columnName == "scholarship_level") {
                ...
                //Doys - end
                //                LEK เช็คว่า ถ้าอายุของบุตรไม่ถึง 3 ปี ให้ฟ้องเตือนว่า  'อายุของบุตรไม่ถึง 3 ปี'
                if (result.year < 3) { alert("อายุของบุตรไม่ถึง 3 ปี"); return; }
                ...
                if (childprename_code == "49" || childprename_code == "01") {
                    objDwDetail.SetItem(1, "child_sex", "01");
                }
                else {
                    objDwDetail.SetItem(1, "child_sex", "02");
                }
            }
