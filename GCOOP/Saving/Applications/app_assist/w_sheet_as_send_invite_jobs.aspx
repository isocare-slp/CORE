<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_as_send_invite_jobs.aspx.cs" Inherits="Saving.Applications.app_assist.w_sheet_as_send_invite_jobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="100px" Width="380px">
        <dw:WebDataWindowControl ID="DwProList" runat="server" DataWindowObject="d_exec_project_invite_list_jobs"
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" Height="500px" Width="100%">
        <dw:WebDataWindowControl ID="DwList" runat="server" DataWindowObject="d_sl_membsrch_list_memno_bygroup"
            LibraryList="~/DataWindow/app_assist/as_seminar.pbl" ClientScriptable="True"
            AutoRestoreContext="False" AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True"
        ...
        <dw:WebDataWindowControl ID="DwListMem" runat="server" DataWindowObject="d_sl_membsrch_list_memno_bymem"
            LibraryList="~/DataWindow/app_assist/as_seminar.pbl" ClientScriptable="True"
            AutoRestoreContext="False" AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True"
            ClientFormatting="True" ClientEventClicked="DwListClick" Visible="False" RowsPerPage="20">
            <PageNavigationBarSettings Position="Top" Visible="True" NavigatorType="Numeric">
                <BarStyle HorizontalAlign="Center" />
                <NumericNavigator FirstLastVisible="True" />
            </PageNavigationBarSettings>
