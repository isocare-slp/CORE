<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_asncapitlaucf.ascx.cs"
    Inherits="Saving.Applications.app_assist.w_sheet_cm_constant_config.u_as_asncapitlaucf" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_as_capital_ucf"
