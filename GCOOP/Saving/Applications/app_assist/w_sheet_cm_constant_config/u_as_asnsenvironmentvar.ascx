<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_asnsenvironmentvar.ascx.cs"
    Inherits="Saving.Applications.app_assist.w_sheet_cm_constant_config.u_as_asnsenvironmentvar" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="u_as_asnsenvironmentvar"
    LibraryList="~/DataWindow/app_assist/as_asnucf.pbl" ClientScriptable="True" Width="760px"
    ClientEventButtonClicked="OnButtonClick"  UseCurrentCulture="True"
    RowsPerPage="30">
