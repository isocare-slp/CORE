<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_asnufreq.ascx.cs"
    Inherits="Saving.Applications.app_assist.w_sheet_cm_constant_config.u_as_asnufreq" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="u_asnufreq"
