<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_ucfenhancequalityoflife.ascx.cs" 
Inherits="Saving.Applications.app_assist.u_as_ucfenhancequalityoflife" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_as_ucf_enhance_quality_of_life"
