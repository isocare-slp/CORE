<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_asnufdamagetype.ascx.cs"
    Inherits="Saving.Applications.app_assist.w_sheet_cm_constant_config.u_as_asnufdamagetype" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="u_asnufdamagetype"
