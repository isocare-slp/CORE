<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_ucfdmemberinvalid.ascx.cs" 
Inherits="Saving.Applications.app_assist.u_as_ucfdmemberinvalid" %>
...
<dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_as_ucf_member_invalid"
