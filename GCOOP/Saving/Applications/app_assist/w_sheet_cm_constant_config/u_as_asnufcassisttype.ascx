<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_as_asnufcassisttype.ascx.cs"
    Inherits="Saving.Applications.app_assist.w_sheet_cm_constant_config.u_as_asnufcassisttype" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="u_asnufcassisttype"
    LibraryList="~/DataWindow/app_assist/as_asnucf.pbl" ClientScriptable="True"
    ClientEventButtonClicked="OnButtonClick" Height="500px" UseCurrentCulture="True"
    RowsPerPage="30">
