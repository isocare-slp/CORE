<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_method.ascx.cs"
    Inherits="Saving.Applications.cmd.u_cm_cmdconfig_method" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if (name == "b_delete") {
                var detail = "รหัสวิธีการที่ได้มา " + objDwMain.GetItem(row, "method_id");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="ptucfmethod"
