<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_reportbuy.ascx.cs"
    Inherits="Saving.Applications.cmd.u_cm_cmdconfig_reportbuy" %>
...
<script type="text/javascript">
    function OnButtonClick(sender, row, name) {
        if (name == "b_delete") {
            var detail = "รหัสเอกสาร" + objDwMain.GetItem(row, "document_code");
...
<dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_cmd_chrlon_reportcmd"
    LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" ClientScriptable="True"
    Width="750px" ClientEventButtonClicked="OnButtonClick" Height="500px">
