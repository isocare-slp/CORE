...
Inherits="Saving.Applications.cmd.u_cm_cmdconfig_productunit" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" 
                        DataWindowObject="ptucfunit" 
        LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" ClientScriptable="True" Width="560px" 
