...
Inherits="Saving.Applications.cmd.u_cm_cmdconfig_statdel" %>
...
<div style="height: 18px; vertical-align: top">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" 
                        DataWindowObject="ptucfstatusdel" LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" ClientScriptable="True" Width="560px" ClientEventButtonClicked="OnButtonClick" Height="300px">
