<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_productstat.ascx.cs" 
Inherits="Saving.Applications.cmd.u_cm_cmdconfig_productstat" %>
...
<script type="text/javascript">
        function OnButtonClick(sender, row, name){
            if (name == "b_delete") {
                var detail = "รหัสสถานะ" + objDwMain.GetItem(row, "productstatus_id");
...
DataWindowObject="ptucfproductstatus" LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl"
 ClientScriptable="True" Width="560px" ClientEventButtonClicked="OnButtonClick" Height="300px">
