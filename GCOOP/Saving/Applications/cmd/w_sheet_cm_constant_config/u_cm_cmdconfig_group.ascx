<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="u_cm_cmdconfig_group.ascx.cs"
 Inherits="Saving.Applications.cmd.u_cm_cmdconfig_group" %>
...
<dw:WebDataWindowControl ID="DwMain" runat="server" 
                        DataWindowObject="dw_cmd_group_mas" LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" 
                        ClientScriptable="True" Width="19cm" ClientEventButtonClicked="OnButtonClick" Height="500px" UseCurrentCulture="True" 
                RowsPerPage="15">
                <PageNavigationBarSettings Visible="True" NavigatorType="Numeric">
            <BarStyle HorizontalAlign="Left" />
            <NumericNavigator FirstLastVisible="True" PageCountPerGroup="15" />
