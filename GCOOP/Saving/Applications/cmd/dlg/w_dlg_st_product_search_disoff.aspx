<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_st_product_search_disoff.aspx.cs"
    Inherits="Saving.Applications.cmd.dlg.w_dlg_st_product_search_disoff" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDetailClick(sender, rowNumber, objectName) {
            ...
            //            if (isConfirm) {
            window.opener.Getitem_idFromDlg(create_id, product_id, product_name, unit_id);
            window.close();
            //}
        }
    </script>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" Width="530px" Font-Bold="True" Font-Names="tahoma"
        ...
        <table style="width: 520px;">
            <tr>
                <td>
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" ClientScriptable="True" DataWindowObject="d_sl_product_search_criteria_disoff"
                        LibraryList="~/DataWindow/Cmd/pointofsale_disoffnew.pbl" Width="460px" ClientEventButtonClicked="b_search_click">
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server" Width="600px" Font-Bold="True" Font-Names="tahoma"
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_sl_product_search_list_disoff"
                LibraryList="~/DataWindow/Cmd/pointofsale_disoffnew.pbl" Width="530px" Style="top: 0px;
