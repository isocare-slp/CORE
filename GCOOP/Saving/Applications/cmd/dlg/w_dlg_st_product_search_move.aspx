<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_st_product_search_move.aspx.cs" Inherits="Saving.Applications.cmd.dlg.w_dlg_st_product_search_move" %>
...
//            var isConfirm = confirm("ยืนยันต้องการเลือกข้อมูล " + product_id + ":" + product_name + ":" + unit_id);
            if (isConfirm) {
                window.opener.Getitem_idFromDlg(slip_id);
                window.close();
            }
        }
...
<body>
    ...
    <table style="width: 520px;">
        <tr>
            <td>
                ...
                DataWindowObject="d_sl_product_search_criteria_move" LibraryList="~/DataWindow/Cmd/pointofsale_move.pbl"
    ...
    <div>
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" 
                DataWindowObject="d_sl_product_search_list_move" LibraryList="~/DataWindow/Cmd/pointofsale_move.pbl"
