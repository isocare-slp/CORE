<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_slip_search_02.aspx.cs"
    Inherits="Saving.Applications.cmd.dlg.w_dlg_slip_search_02" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDetailClick(sender, rowNumber, objectName) {
            var slip_id = objdw_detail.GetItem(rowNumber, "asslpslipmas_slip_id");
...
<body>
    ...
    <table style="width: 530px;">
        <tr>
            <td>
                <dw:WebDataWindowControl ID="Dw_main" runat="server" ClientScriptable="True" DataWindowObject="d_stk_slip_search_02"
                    LibraryList="~/DataWindow/Cmd/dlg_search.pbl" Width="500px">
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server" Width="600px" Font-Bold="True" Font-Names="tahoma"
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_stk_searchslipdea_02_pt"
                LibraryList="~/DataWindow/Cmd/dlg_search.pbl" Width="530px" Style="top: 0px;
