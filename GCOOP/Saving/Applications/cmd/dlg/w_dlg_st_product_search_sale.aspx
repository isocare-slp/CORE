<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_st_product_search_sale.aspx.cs"
    Inherits="Saving.Applications.cmd.dlg.w_dlg_st_product_search_sale" %>
            ...
            <tr>
                <td>
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" ClientScriptable="True"
                        DataWindowObject="d_sl_product_search_criteria_sale" LibraryList="~/DataWindow/Cmd/pointofsale.pbl"
                        Width="470px">
