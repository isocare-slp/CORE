<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_slip_search_disoff.aspx.cs"
    Inherits="Saving.Applications.cmd.dlg.w_dlg_slip_search_disoff" %>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="Dw_main" runat="server" ClientScriptable="True"
                    DataWindowObject="d_stk_slip_search_disoff" LibraryList="~/DataWindow/Cmd/pointofsale_disoffnew.pbl"
                    Width="500px">
    ...
    <div>
        ...
        <asp:Panel ID="Panel2" runat="server" Width="600px" Font-Bold="True" Font-Names="tahoma"
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" 
                DataWindowObject="d_stk_searchslipdea_disoff" LibraryList="~/DataWindow/Cmd/pointofsale_disoffnew.pbl"
