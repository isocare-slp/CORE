<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_cmd_subgroup_list.aspx.cs" Inherits="Saving.Applications.cmd.dlg.w_dlg_cmd_subgroup_list" %>
...
<head id="Head1" runat="server">
    ...
    function dwListClick(sender, rowNumber, buttonName) {
        if (buttonName == "btn_del") {
            if (confirm("ยืนยันการลบข้อมูล")) {
                Gcoop.GetEl("HdSelectRow").value = rowNumber;
                postDelete();
            }
...
<body>
    ...
    <div>
            <dw:WebDataWindowControl ID="dw_list" runat="server" DataWindowObject="dw_cmd_subgroup_master"
                LibraryList="~/DataWindow/Cmd/cm_constant_config.pbl" RowsPerPage="14" ClientScriptable="True"
                AutoRestoreContext="false" AutoRestoreDataCache="true" AutoSaveDataCacheAfterRetrieve="True"
                ClientFormatting="True" ClientEventButtonClicked="dwListClick">
         ...
         <asp:HiddenField ID="HdGroup_id" runat="server" />
