<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_st_product_combine.aspx.cs" Inherits="Saving.Applications.cmd.dlg.w_dlg_st_product_combine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDetailClick(sender, rowNumber, objectName) {
            ...
            if (isConfirm) {
                window.opener.GetProductFromDlg(product_id, product_name, unit_id);
                window.close();
            }
        }
    </script>
            ...
            <tr>
                <td>
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" ClientScriptable="True"
                        DataWindowObject="d_sl_product_search_criteria_com" LibraryList="~/DataWindow/Cmd/cmd_item_cr.pbl"
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server" Width="530px" Font-Bold="True" Font-Names="tahoma"
            ...
            <dw:WebDataWindowControl ID="dw_detail" runat="server" 
                DataWindowObject="d_sl_product_search_list_com" LibraryList="~/DataWindow/Cmd/cmd_item_cr.pbl"
                 Width="530px" Style="top: 1px;
