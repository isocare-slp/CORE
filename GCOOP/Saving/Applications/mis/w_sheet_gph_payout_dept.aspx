<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_gph_payout_dept.aspx.cs" Inherits="Saving.Applications.mis.w_sheet_gph_payout_dept" %>
            ...
            <td valign="top">
                    ...
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text="การถอนเงินฝากเทียบเดือน"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_month" runat="server" DataWindowObject="d_mis_gph_payout_dept"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_dept.pbl" Width="720px" AutoRestoreContext="False"
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_month" runat="server" DataWindowObject="d_mis_gphdata_payout_dept"
                                    LibraryList="~/DataWindow/mis/payout_dept.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                ...
                <div id="tab_2" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="การถอนเงินฝากเทียบไตรมาส"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_quar" runat="server" DataWindowObject="d_mis_gph_payout_dept_quarter"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_dept.pbl" Width="720px" AutoRestoreContext="False"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_quar" runat="server" DataWindowObject="d_mis_gphdata_payout_dept_quarter"
                                    LibraryList="~/DataWindow/mis/payout_dept.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
                ...
                <div id="tab_3" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" Text="การถอนเงินฝากเทียบครึ่งปี"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_half" runat="server" Height="400px" LibraryList="~/DataWindow/mis/payout_dept.pbl"
                                    Width="720px" AutoRestoreContext="False" DataWindowObject="d_mis_gph_payout_dept_half"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_half" runat="server" LibraryList="~/DataWindow/mis/payout_dept.pbl"
                                    AutoRestoreContext="False" AutoRestoreDataCache="True" DataWindowObject="d_mis_gphdata_payout_dept_half"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
                        </tr>
                ...
                <div id="tab_4" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Text="การถอนเงินฝากเทียบปี"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_year" runat="server" DataWindowObject="d_mis_gph_payout_dept_year"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_dept.pbl" Width="720px" AutoRestoreContext="False"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_year" runat="server" DataWindowObject="d_mis_gphdata_payout_dept_year"
                                    LibraryList="~/DataWindow/mis/payout_dept.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
