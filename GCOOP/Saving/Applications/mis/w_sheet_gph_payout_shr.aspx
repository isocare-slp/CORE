<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_gph_payout_shr.aspx.cs" Inherits="Saving.Applications.mis.w_sheet_shareback" %>
            ...
            <td valign="top">
                    ...
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" Text="การคืนค่าหุ้น(ถอนหุ้น)เทียบเดือน"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_month" runat="server" DataWindowObject="d_mis_gph_payout_shr"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_shr.pbl" Width="720px" AutoRestoreContext="False"
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_month" runat="server" DataWindowObject="d_mis_gphdata_payout_shr"
                                    LibraryList="~/DataWindow/mis/payout_shr.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                ...
                <div id="tab_2" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="การคืนค่าหุ้น(ถอนหุ้น)เทียบไตรมาส"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_quar" runat="server" DataWindowObject="d_mis_gph_payout_shr_quarter"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_shr.pbl" Width="720px" AutoRestoreContext="False"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_quar" runat="server" DataWindowObject="d_mis_gphdata_payout_shr_quarter"
                                    LibraryList="~/DataWindow/mis/payout_shr.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
                ...
                <div id="tab_3" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Large" Text="การคืนค่าหุ้น(ถอนหุ้น)เทียบครึ่งปี"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_half" runat="server" Height="400px" LibraryList="~/DataWindow/mis/payout_shr.pbl"
                                    DataWindowObject="d_mis_gph_payout_shr_half" Width="720px" AutoRestoreContext="False"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_half" runat="server" LibraryList="~/DataWindow/mis/payout_shr.pbl"
                                    DataWindowObject="d_mis_gphdata_payout_shr_half" AutoRestoreContext="False" AutoRestoreDataCache="True"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
                        </tr>
                ...
                <div id="tab_4" style="visibility: hidden; position: absolute;">
                    <table style="height: 600px; width: 724">
                        <tr>
                            <td class="style2" colspan="2">
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Text="การคืนค่าหุ้น(ถอนหุ้น)เทียบปี"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td colspan="2">
                                <dw:WebDataWindowControl ID="dw_graph_year" runat="server" DataWindowObject="d_mis_gph_payout_shr_year"
                                    Height="400px" LibraryList="~/DataWindow/mis/payout_shr.pbl" Width="720px" AutoRestoreContext="False"
                                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True">
                                    <GraphConfigurations ImageFormat="Gif" RenderOption="ImageFile" GraphDynamicImageFileUrlPath="~/Applications/mis/graph" />
                                </dw:WebDataWindowControl>
                        ...
                        <tr>
                            <td colspan="2" style="vertical-align: top">
                                <dw:WebDataWindowControl ID="dw_data_year" runat="server" DataWindowObject="d_mis_gphdata_payout_shr_year"
                                    LibraryList="~/DataWindow/mis/payout_shr.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
                                    AutoSaveDataCacheAfterRetrieve="True">
                                </dw:WebDataWindowControl>
                            </td>
