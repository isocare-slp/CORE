<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_camels_mis.aspx.cs" Inherits="Saving.Applications.mis.w_sheet_camels_mis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <span style="cursor: pointer" onclick="OnClickLinkNext();">-พิมพ์รายงานอัตราส่วนทางการเงินที่สำคัญ</span>
    <br />
