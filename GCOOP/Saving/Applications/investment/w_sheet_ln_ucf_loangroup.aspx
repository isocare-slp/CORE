<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_ln_ucf_loangroup.aspx.cs" Inherits="Saving.Applications.investment.w_sheet_ln_ucf_loangroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_lc_lccfgrploanpermiss"
    ...
    <asp:Label ID="Label2" runat="server" Text="หมายเหตุ : ห้ามแก้ไขรหัสกลุ่มวงเงินกู้" Font-Bold="False" Font-Names="Tahoma"
