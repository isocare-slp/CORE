<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_ln_ucf_loanobjective.aspx.cs" Inherits="Saving.Applications.investment.w_sheet_ln_ucf_loanobjective" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_lc_lcucfloanobjective"
    ...
    <asp:Label ID="Label2" runat="server" Text="หมายเหตุ : ห้ามแก้ไขรหัสวัตถุประสงค์การขอกู้" Font-Bold="False" Font-Names="Tahoma"
