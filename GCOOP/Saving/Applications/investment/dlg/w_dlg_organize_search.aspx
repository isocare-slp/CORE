<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_organize_search.aspx.cs"
    Inherits="Saving.Applications.investment.dlg.w_dlg_organize_search" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function selectRow(sender, rowNumber, objectName) {
            var memno = objdw_detail.GetItem(rowNumber, "org_memno");
            var memname = objdw_detail.GetItem(rowNumber, "org_name");
            window.opener.GetMemDetFromDlg(memno, memname);
            window.close();
        }
    </script>
</head>
<body>
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_ol_search_member_detailcont_nojoin" LibraryList="~/DataWindow/investment/int_editdetail.pbl"
