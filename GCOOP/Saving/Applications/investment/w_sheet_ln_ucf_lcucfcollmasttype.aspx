<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_ln_ucf_lcucfcollmasttype.aspx.cs" Inherits="Saving.Applications.investment.w_sheet_ln_ucf_lcucfcollmasttype" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_lc_lcucfcollmasttype"
    ...
    <asp:Label ID="Label2" runat="server" Text="หมายเหตุ : ห้ามแก้ไขรหัสหลักทรัพย์" Font-Bold="False" Font-Names="Tahoma"
