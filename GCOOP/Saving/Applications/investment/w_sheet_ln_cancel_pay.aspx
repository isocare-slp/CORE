<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_ln_cancel_pay.aspx.cs" Inherits="Saving.Applications.loan.w_sheet_ln_cancel_pay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <hr />
        <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="d_lcsrv_list_ccllnrcv"
