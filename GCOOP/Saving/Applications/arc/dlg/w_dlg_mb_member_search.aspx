<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_mb_member_search.aspx.cs" Inherits="Saving.Applications.arc.dlg.w_dlg_mb_member_search" %>
...
//            , prename_desc, memb_name, memb_surname, card_person
            window.close();
        }
    </script>
