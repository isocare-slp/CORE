<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_hr_arc_master_getting.aspx.cs" Inherits="Saving.Applications.arc.w_sheet_hr_arc_master_getting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td valign="top">
                <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="hr_arc_master_detail_forget"
        ...
        <tr>
          <td class="style5" valign="top">
            ...
            <td colspan="2">
                ...
                <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="dw_arc_master_head_getting"
                    LibraryList="~/DataWindow/arc/hr_arc_master.pbl" AutoSaveDataCacheAfterRetrieve="True"
                    AutoRestoreDataCache="True" AutoRestoreContext="False" ClientScriptable="True"
