<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_paper_cashflow_drcr.aspx.cs" Inherits="Saving.Applications.account.w_acc_paper_cashflow_drcr" Title="Untitled Page" %>
        ...
        <tr>
            <td valign="top">
                    <dw:WebDataWindowControl ID="dw_rpt" runat="server" Width="740" Height="600" HorizontalScrollBar="Fixed"
                        ...
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" 
                        ClientScriptable="True" DataWindowObject="r_mth40_mth_cashflow_drcr" 
                        LibraryList="~/DataWindow/account/acc_report_design.pbl" 
