<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_edit_detail_deptslip.aspx.cs" Inherits="Saving.Applications.account.w_acc_edit_detail_deptslip" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style1">
                <asp:Panel ID="Panel1" runat="server" Height="70px" Width="700px">
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" DataWindowObject="d_dlg_daterange_deptslip"
        ...
        <tr>
            ...
            <div id="detail" runat="server">
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_vc_edit_detail_deptslip"
                    LibraryList="~/DataWindow/account/vc_voucher_edit.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
