<%@ Page Title="" Language="C#" MasterPageFile="~/FrameDialog.Master" AutoEventWireup="true"
    CodeBehind="w_dlg_vc_trn_share.aspx.cs" Inherits="Saving.Applications.account.dlg.w_dlg_vc_trn_share_ctrl.w_dlg_vc_trn_share" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function SortbyColumn(s, col) {
            ...
            var arr_col = ["operate_flag", "payoutslip_no", "member_no", "memb_name", "membgroup_code", "slip_date", "moneytype_code", "payout_amt"];
