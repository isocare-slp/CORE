<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_paper_cashflow_atv.aspx.cs" Inherits="Saving.Applications.account.w_acc_paper_cashflow_atv" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function OpenProcess(s,r,c){
            var isconfirm = confirm("ยืนยันการจัดทำ ?");
            if (!isconfirm){
            return false;        
            }
            postOpenReport();
        ...
        <tr>
            <td valign="top" align="center">
                <dw:WebDataWindowControl ID="dw_main" runat="server" AutoRestoreContext="False" 
                    ...
                    ClientScriptable="True" DataWindowObject="d_ac_cri_mth30_rang_papercashflow" 
    ...
    <table style="width: 100%;">
        <tr>
            <td valign="top" align="right">
                <span id="OpenProcess" class="style2" onclick="OpenProcess()">เริ่มจัดทำ</span> 
            </td>
        </tr>
    </table>
    <table style="width: 100%;">
        <tr>
            <td valign="top">
                    <dw:WebDataWindowControl ID="dw_rpt" runat="server" Width="740" Height="600" HorizontalScrollBar="Fixed"
                        ...
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" 
                        ClientScriptable="True" DataWindowObject="r_mth40_mth_cashflow_activities" 
                        LibraryList="~/DataWindow/account/acc_report_design.pbl" 
