<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_report_excel.aspx.cs" Inherits="Saving.Applications.account.w_acc_report_excel" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style1">
                <asp:Panel ID="Panel1" runat="server" Height="70px" Width="700px">
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" DataWindowObject="d_dlg_daterange"
        ...
        <tr>
            ...
            <div id="detail" runat="server">
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_acc_report_excel_fin_test"
                    LibraryList="~/DataWindow/account/vc_report.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
