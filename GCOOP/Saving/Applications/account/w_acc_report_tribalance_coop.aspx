<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_report_tribalance_coop.aspx.cs" Inherits="Saving.Applications.account.w_acc_report_tribalance_coop" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td class="style1">
                <asp:Panel ID="Panel1" runat="server" Height="70px" Width="700px">
                    <dw:WebDataWindowControl ID="Dw_main" runat="server" DataWindowObject="d_dlg_daterange_21032400"
                    LibraryList="~/DataWindow/account/vc_report.pbl" AutoRestoreContext="False" AutoRestoreDataCache="True"
        ...
        <tr>
            ...
            <div id="detail" runat="server">
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="r_mth20_tribalance_coop_retrive_2"
                    LibraryList="~/DataWindow/account/vc_report.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
