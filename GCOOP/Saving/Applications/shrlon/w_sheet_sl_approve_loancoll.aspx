<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_approve_loancoll.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_approve_loancoll" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ItemChanged(sender, rowNumber, columnName, newValue) {
            if (columnName == "coop_id") {
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();

            } else if (columnName == "loanrequest_tdate") {
                objdw_main.SetItem(1, "loanrequest_tdate", newValue);
                objdw_main.AcceptText();
                objdw_main.SetItem(1, "loanrequest_date", Gcoop.ToEngDate(newValue));
                objdw_main.AcceptText();
                jsfillter();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_loansrv_criteria"
        LibraryList="~/DataWindow/shrlon/sl_approve_loan.pbl" AutoRestoreContext="False"
                ...
                <table style="width: 100%;" border="1" width="80px" bgcolor="#D3E7FF">
                    <tr>
                        ...
                        <td align="center" width="150px">
                            <input style="height: 35px; width: 45px; background-color: Yellow; color: Black;" id="b_wait"
                                type="button" value="รอ" onclick="b_wait_onclick()" class="style2" />
                            ...
                            <input style="height: 35px;  width: 45px; background-color: #33CC33; color: Black;" id="b_approve"
                                type="button" value="มีเลข" onclick="b_approve_onclick()" class="style2" />
        ...
        <tr>
            <td id="table_list" style="height: 400px;" valign="top">
                <dw:WebDataWindowControl ID="dw_master" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                    DataWindowObject="d_sl_apvloan_list_coll" LibraryList="~/DataWindow/shrlon/sl_approve_loan.pbl"
