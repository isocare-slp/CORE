...
{
    public partial class w_sheet_sl_loan_requestment_gun : PageWebSheet, WebSheet
    {
        private DwThDate tDwMain;
        private ShrlonClient shrlonService;
        private CommonClient commonService;

        protected String calLoanrequestAMT;
        ...
        {
            calLoanrequestAMT = WebUtil.JsPostBack(this, "calLoanrequestAMT");
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (dw_main.RowCount < 1)
            {
                ...
                try
                {
                    ...
                    if (loantype == "")
                    {
                        dw_main.SetItemString(1, "loantype_code", "28");                //กำหนดค่าเริ่มต้น เป็นกู้ปืน
                    }
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "calLoanrequestAMT")
            {
                CalLoanrequestAMT();
            }
        ...
        private void CalLoanrequestAMT()
        {
            Decimal gunPrice = dw_main.GetItemDecimal(1, "gunprice_amt");
            Decimal manageAMT = dw_main.GetItemDecimal(1, "manage_amt");
            Decimal loanrequestAMT;

            loanrequestAMT = gunPrice + manageAMT;
            dw_main.SetItemDecimal(1, "loanrequest_amt", loanrequestAMT);
            HdColumnName.Value = "loanrequest_amt";
            JsPostMember();
        }
        ...
        private void JsPostMember()
        {
            try
            {
                ...
                ////Boom ส่วน ฉ.โอน Reqloop กู้ปืน ไม่ได้ใช้ ReqLoop
                //try
                //{
        ...
        private void SetDWOthClr()
        {
            ...
            String xmlMain = "";
            xmlMain = shrlonService.SetSumOtherClr(state.SsWsPass, strList.xml_main, strList.xml_otherclr);
            try
            {
                dw_main.Reset();
                dw_main.ImportString(xmlMain, FileSaveAsType.Xml);
