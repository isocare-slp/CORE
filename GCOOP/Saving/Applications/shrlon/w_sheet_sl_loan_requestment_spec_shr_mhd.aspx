<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_requestment_spec_shr_mhd.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_spec_shr_mhd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ItemDwMainChanged(sender, rowNumber, columnName, newValue) {
            ...
            } else if (columnName == "period_payamt" || columnName == "loanpayment_type") {
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();
                jsContPeriod();
