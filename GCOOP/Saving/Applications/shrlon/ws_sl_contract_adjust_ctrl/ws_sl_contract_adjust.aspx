...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnDsMainClicked(s, r, c) {
            if (c == "b_search") {
                Gcoop.OpenIFrame2Extend("630", "720", "w_dlg_sl_member_search_tks.aspx", "")
            }
        ...
        function OnDsCollClicked(s, r, c) {
            if (c == "b_del") {
                ...
                if (loancolltype_code == "01") {
                    ...
                    Gcoop.GetEl("HdCollRow").value = r;
                    var coop_id = dsMain.GetItem(0, "memcoop_id");
                    Gcoop.OpenIFrameExtend('600', '600', 'w_dlg_sl_loanmember_search.aspx', "?coopId=" + coop_id);

                } else if (loancolltype_code == "03") {
                    //03 เงินฝากหลักประกัน
                    Gcoop.GetEl("HdCollRow").value = r;
                    Gcoop.OpenIFrameExtend(860, 250, "w_dlg_dp_account_search.aspx", "?member=" + member_no);

                } else if (loancolltype_code == "04") {
                    //04 หลักทรัพย์ค้ำประกัน
                    Gcoop.GetEl("HdCollRow").value = r;
                    Gcoop.OpenIFrameExtend('700', '300', 'w_dlg_sl_collmaster_search_req.aspx', "?member=" + member_no + "&loantype_code=" + loantype_code);
