<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_requestment_gun.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_gun" Title="Untitled Page" %>
...
//            alert(collRefNo);
        ...
        function MenubarNew(){
            window.location = Gcoop.GetUrl() + "Applications/shrlon/w_sheet_sl_loan_requestment_gun.aspx";
        }
...
//                PrePareBranch(rowNumber, columnName , newValue);
                ...
                PrePareData (rowNumber, columnName , newValue );
            }else if (( columnName == "gunprice_amt")||( columnName == "manage_amt")){
                 objdw_main.SetItem( rowNumber, columnName, newValue);
                 objdw_main.AcceptText();
                 calLoanrequestAMT();
            }
    ...
    <table style="width: 100%;" border="0">
        <tr>
            <td valign="top" colspan="2">
                <dw:WebDataWindowControl ID="dw_main" runat="server" DataWindowObject="d_sl_loanrequest_master_gun"
        ...
        <tr>
            <td valign="top" colspan="2">
               ...
               <%-- <span class="linkSpan" style="cursor: pointer;" onclick="OnInsert('10');">เพิ่มแถว</span>
                <br />--%>
                <dw:WebDataWindowControl ID="dw_coll" runat="server" DataWindowObject="d_sl_loanrequest_collateral_norm"
                    LibraryList="~/DataWindow/Shrlon/sl_loan_requestment.pbl" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
