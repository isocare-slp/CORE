<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kp_slcls_year_loan.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_kp_slcls_year_loan" %>
            ...
            <tr>
                <td colspan="3">
                    <dw:WebDataWindowControl ID="Dw_option" runat="server" 
                        ...
                        ClientScriptable="True" DataWindowObject="d_slclssrv_prc_year_lon_option" 
                        LibraryList="~/DataWindow/keeping/kp_slcls_year_loan.pbl" 
            ...
            <tr>
                <td colspan="3">
                    <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Auto">
                        ...
                        AutoRestoreContext="False" AutoRestoreDataCache="True" 
                        AutoSaveDataCacheAfterRetrieve="True" ClientFormatting="True" 
                        ClientScriptable="True" DataWindowObject="d_slclssrv_prc_year_lon_docctrl_list" 
                        LibraryList="~/DataWindow/keeping/kp_slcls_year_loan.pbl" 
