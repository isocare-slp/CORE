<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_requestment_commonmhd.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_commonmhd" %>
    ...
    <script type="text/javascript">
        ...
        function ItemDwMainChanged(sender, rowNumber, columnName, newValue) {
            if ((columnName == "loantype_code") || (columnName == "loantype_code_1")) {
                ...
                if (loanrequest_amt > loancredit_amt || loanrequest_amt > 2200000) {
                    //hardcode
        ...
        function SheetLoadComplete() {
            if (Gcoop.GetEl("HdIsPostBack").value != "true") {
                ...
                var member_no = objdw_main.GetItem(1, "member_no");
                Gcoop.OpenDlg(855, 620, 'w_dlg_sl_popup_loanreceive_order.aspx', '?member_no=' + member_no);
                jsReNewPage();
            }
        }
