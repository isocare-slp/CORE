    ...
    <script type="text/javascript">
        ...
        function ItemChangedMain(sender, rowNumber, columnName, newValue) {
            if (columnName == "member_no") {
                ...
                jsPostMember();
            } else if (columnName == "loanrequest_docno") {
                objdw_main.SetItem(rowNumber, columnName, newValue);
                objdw_main.AcceptText();
                Gcoop.GetEl("Hdloanrequestdocno").value = newValue;
        ...
        function dw_main_search(s, r, c) {
            ...
            } else if (c == "b_addlnreq") {
                var loanreq_docno = objdw_main.GetItem(1, "loanrequest_docno");
                var membno = objdw_main.GetItem(1, "member_no");
                Gcoop.OpenIFrame('680', '450', 'w_dlg_ln_add_collmast_lnreq.aspx', '?loanrequest_docno=' + loanreq_docno + '&member_no=' + membno);
        ...
        function dw_review_search(s, r, b) {
            if (b == "b_delreview") {
                ...
                objdw_review.DeleteRow(r);
                
            } else if (b == "b_copydetail") {
        ...
        function dw_owndetail(s, r, b) {
            if (b == "b_del") {
                alert(b);
                objdw_detail_02.DeleteRow(r);
                //jsRefresh();
            } else if (b == "b_copyown") {
                objdw_detail_02.AcceptText();
                jsCopyDetailownland();
            }
            return 0;
        }
        ...
        function Changedetail(sender, rowNumber, columnName, newValue) {
            if (columnName == "memco_no") {
                dw_detail.SetItem(rowNumber, columnName, Gcoop.StringFormat(newValue, "00000000"));
                dw_detail.AcceptText();
                Gcoop.GetEl("Hfmember_no").value = Gcoop.StringFormat(newValue, "00000000");
                jsgetmember();
            }
        ...
        function Changedetail_mrtg2(sender, rowNumber, columnName, newValue) {
            if (columnName == "own_province") {
                Gcoop.GetEl("Hf_province").value = columnName;
                objdw_detail_02.SetItem(rowNumber, columnName, newValue);
                objdw_detail_02.AcceptText();
                jspostPorvince();
            }
        }
        ...
        //wa
        function Changedetail_mrtg3(sender, rowNumber, columnName, newValue) {
        ...
        function JsCalmortgage() {
            jsCalmortgage();
        }
        function collmastrefresh() {
            jsPostMember();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="Hdloanrequestdocno" runat="server" Value="" />
    <asp:HiddenField ID="Hdlistrow" runat="server" Value="" />
        ...
        <tr>
            ...
            <td colspan="4" valign="top">
                ...
                <tr><td>
                    ...
                    <td></td>
                    <td>
                     <a href="#" onclick="JsCalmortgage()">
                        <asp:Label ID="Label3" runat="server" Text="คำนวณจำนอง" CssClass="linkInsertRow"></asp:Label>
                    </a>
                    </td>
                    </tr></table>
                    ...
                    <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_loansrvl_lncollmast_memco"
                      ...
                      <a href="#" onclick="InsertRowreqloan()">
                        <asp:Label ID="Label4" runat="server" Text="ใบคำขอกู้" CssClass="linkInsertRow"></asp:Label>
                    </a>
                    <dw:WebDataWindowControl ID="dw_reqloan" runat="server" DataWindowObject="d_sl_loanreq_collmast"
                        LibraryList="~/DataWindow/shrlon/sl_collateral_master.pbl" AutoRestoreContext="False"
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                ...
                <a href="#" onclick="Insertowndetail()">
                        <asp:Label ID="Label6" runat="server" Text="เพิ่ม" CssClass="linkInsertRow"></asp:Label>
                    </a>
                    <dw:WebDataWindowControl ID="dw_detail_02" runat="server" DataWindowObject="d_loansrv_lncollmast_own_detwa"
                        LibraryList="~/DataWindow/shrlon/sl_collateral_master.pbl" AutoRestoreContext="False"
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                        ClientFormatting="True" ClientEventButtonClicked="dw_owndetail" ClientEventItemChanged="Changedetail_mrtg3">
                    </dw:WebDataWindowControl>
                </div>
                ...
                <div id="tab6" style="visibility: hidden;  position: absolute;">
                 <a href="#" onclick="InsertRowreview()">
                        <asp:Label ID="Label5" runat="server" Text="เพิ่ม" CssClass="linkInsertRow"></asp:Label>
                    </a>
                    <dw:WebDataWindowControl ID="dw_review" runat="server" DataWindowObject="d_loansrv_lncollmast_mrtg_detwa"
                        LibraryList="~/DataWindow/shrlon/sl_collateral_master.pbl" AutoRestoreContext="False"
                        AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                        ClientFormatting="True" ClientEventButtonClicked="dw_review_search" ClientEventItemChanged="Changedetail_review">
                    </dw:WebDataWindowControl>
