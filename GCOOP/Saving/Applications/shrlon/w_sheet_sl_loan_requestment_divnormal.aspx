<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_requestment_divnormal.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_divnormal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ItemDwMainChanged(sender, rowNumber, columnName, newValue) {
            ...
            else if (columnName == "sum_clear") {
                objdw_main.SetItem(rowNumber, "sum_clear", newValue);
                objdw_main.AcceptText();
            }
        }
...
//             else {
//                var member_no = objdw_main.GetItem(1, "member_no");
//                Gcoop.OpenDlg(855, 620, 'w_dlg_sl_popup_loanreceivediv.aspx', '?member_no=' + member_no);
//                jsReNewPage();
//            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Visible="false" OnClick="LinkButton1_Click">พิมพ์หักเงินฝาก</asp:LinkButton>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td>
                ...
                <dw:WebDataWindowControl ID="dw_otherclr" runat="server" DataWindowObject="d_sl_loanrequest_otherclr"
                    ...
                    BorderStyle="solid" BorderColor="white" TabIndex="500" Width="300px" Height="250px">
                </dw:WebDataWindowControl>
            </td>
            <td>
                <asp:Label ID="Label2" runat="server" Text="รายการหักกลบ" Font-Bold="True"></asp:Label>
                <dw:WebDataWindowControl ID="dw_clear" runat="server" DataWindowObject="d_sl_loanrequest_clear_etc"
                    LibraryList="~/DataWindow/Shrlon/sl_loan_requestment_cen.pbl" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
                    ClientFormatting="True" ClientEventClicked="OnDwClearClicked" ClientEventItemChanged="ItemDwClearChanged"
                    TabIndex="600" Width="480px" Height="250px">
                </dw:WebDataWindowControl>
            </td>
        </tr>
    </table>
