<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_approve_loan.aspx.cs"
    Inherits="Saving.Applications.shrlon.w_sheet_sl_approve_loan" Title="Untitled Page" %>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_cri" runat="server" AutoRestoreContext="False" AutoRestoreDataCache="True"
                    AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True" DataWindowObject="d_sl_cri_apvloan_list_pp"
        ...
        <tr>
            <td>
                <table style="width: 100%;" border="1" width="80px" bgcolor="#D3E7FF">
                    <tr>
                        <td align="center" width="105px" class="style1">
                            ใบคำร้อง
                        </td>
                        <td align="center" width="55px" class="style1">
                            ประเภท
                        </td>
                        <td align="center" width="223px" class="style1">
                            ทะเบียน ชื่อ-สกุล
                        </td>
                        <td align="center" width="107px" class="style1">
                            เงินขอกู้
                        </td>
