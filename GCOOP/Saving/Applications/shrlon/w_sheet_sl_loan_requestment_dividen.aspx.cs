...
{
    public partial class w_sheet_sl_loan_requestment_dividen : PageWebSheet, WebSheet
    {
        public String lc_loangroup = "01";
        public String lc_loantype = "23";
        ...
        public void SaveWebSheet()
        {
            ...
            try
            {
                ...
                String loan_no = shrlonService.GenReqDocNo(state.SsWsPass, state.SsCoopControl, loantype_code);
                ...
                else
                {
                    ...
                    if (ret == 1)
                    {
                        ...
                        Session["loantypeCodediv"] = ls_loantype;
        ...
        private void JsChangeStartkeep()
        {
            try
            {
                ...
                ldtm_loanrequest = wcf.InterPreter.GetPaydividen(state.SsCoopControl, state.SsWorkDate);
                ...
                dw_main.SetItemDate(1, "startkeep_date", ldtm_loanrequest);
                tDwMain.Eng2ThaiAllRow();
        ...
        private void JsGetMemberInfo()
        {
            try
            {
                ...
                Decimal ldc_shrstkvalue = 0, ldc_shrstkbegin = 0;
                    ...
                    else
                    {
                        ...
                        else    //ไม่มีสัญญาเก่าค้าง
                        {
                            ...
                            String sqlstr = @"   SELECT a.membgroup_control,
                                             ...
                                             SHSHAREMASTER.SHARESTK_AMT,   (SHSHAREMASTER.SHAREBEGIN_AMT*10)as SHAREBEGIN_AMT,  
                            ...
                            while (dt.Next())
                            {
                                ...
                                ldc_shrstkbegin = dt.GetDecimal("sharebegin_amt");
                            ...
                            decimal dividend_rate = Convert.ToDecimal(wcf.InterPreter.Getpersentdividen(state.SsCoopControl));
                            Decimal loancredit_amt = ldc_shrstkbegin * dividend_rate;
                            decimal loanrequest_amt = Convert.ToDecimal(wcf.InterPreter.GetMaxloanrequest_dividen(state.SsCoopControl, loancredit_amt));
                            Ltdividen.Text = WebUtil.CompleteMessage("ยอดหุ้นยกมาต้นปี =  " + ldc_shrstkbegin.ToString("###,###,###,###.00") + " ||  อัตราปันผลปีที่แล้ว = " + Convert.ToString(dividend_rate ) + " % ");
                            //mong
                            ...
                            if (loancredit_amt > 0)
                            {
                                ...
                                dw_main.SetItemDecimal(1, "loanpermiss_amt", loancredit_amt);
                                ...
                                period_payment = loanrequest_amt / 12;
                                if (roundpay > 0)
                                {
                                    //by mong
                                ...
                                dw_main.SetItemDecimal(1, "period_payment", loanrequest_amt);

                            }
                            else
                            {
                                dw_main.SetItemDecimal(1, "loancredit_amt", 0);
                                dw_main.SetItemDecimal(1, "loanpermiss_amt", 0);
                                dw_main.SetItemDecimal(1, "loanrequest_amt", 0);
                                dw_main.SetItemDecimal(1, "maxsend_payamt", 0);
                                dw_main.SetItemDecimal(1, "period_payamt", 0);
        ...
        public Decimal of_calintestimatemain()
        {
            ...
            Decimal loanrequest_amt, ldc_inttotal = 0, ldc_prncalint;
            Decimal ldc_contintrate, ldc_intincrease;
            DateTime ldtm_calintfrom, ldtm_calintto, ldtm_rcvfix, ldtm_estimate, ldtm_loanrequest;
            try
            {
                ...
                ldtm_loanrequest = dw_main.GetItemDateTime(1, "loanrequest_date");
                loanrequest_amt = dw_main.GetItemDecimal(1, "loanrequest_amt");
                ldtm_rcvfix = dw_main.GetItemDateTime(1, "startkeep_date");


                ldtm_estimate = ldtm_rcvfix.AddDays(31);


                Decimal day_amount = 366 + ldtm_rcvfix.DayOfYear - ldtm_loanrequest.DayOfYear;
                ldc_inttotal = loanrequest_amt * ldc_contintrate * day_amount / 365;
