<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_requestment_spec_mhd.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_spec_mhd" %>
    ...
    <script type="text/javascript">
        ...
        function ItemDwMainChanged(sender, rowNumber, columnName, newValue) {
            if ((columnName == "loantype_code") || (columnName == "loantype_code_1")) {
                ...
                Gcoop.GetEl("Hloantype_code").value = newValue;
                objdw_main.AcceptText();
                var member_no;
                var member_name;
                try {
                ...
                objdw_main.SetItem(1, "loanrcvfix_tdate", newValue);
                objdw_main.AcceptText();
                ...
                objdw_main.SetItem(rowNumber, "incomemonth_other", newValue);
                objdw_main.AcceptText();
                jsPermissSalary();
            }
            else if (columnName == "incomemonth_fixed") {
                objdw_main.SetItem(rowNumber, "incomemonth_fixed", newValue);
                objdw_main.AcceptText();
                jsPermissSalary();
        ...
        function OnDwMainClicked(sender, rowNumber, objectName) {
            ...
            if ((objectName == "loanrcvfix_flag") || (objectName == "clearloan_flag") || (objectName == "otherclr_flag") || (objectName == "custompayment_flag") || (objectName == "intcertificate_status")) {
                ...
                if (objectName == "intcertificate_status") {
                    Gcoop.CheckDw(sender, rowNumber, objectName, "intcertificate_status", 1, 0);
                    jsRefresh();
                }
                ...
                //                    alert(1);
                Gcoop.GetEl("HdColumnName").value = objectName;
                Gcoop.GetEl("HdColumnName").value = "b_chgaccid";
        ...
        function ItemDwCollChanged(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "ref_collno") {
                objdw_coll.SetItem(rowNumber, columnName, Gcoop.StringFormat(newValue, "00000000"));
                objdw_coll.AcceptText();
                Gcoop.GetEl("HdRefcoll").value = Gcoop.StringFormat(newValue, "00000000");
                ...
                if (loancolltype_code == "02") {
                    jsGetMemberCollno();
                } else if (loancolltype_code == "05") {

                    objdw_coll.SetItem(rowNumber, "ref_collno", "ex0001");
                    objdw_coll.SetItem(rowNumber, "description", "หลักทรัพย์ค้ำประกันรอประเมิน");
                    objdw_coll.AcceptText();
                } else if (loancolltype_code == "04") {

                    var memberNoVal = objdw_main.GetItem(1, "member_no");

                    Gcoop.OpenDlg(620, 250, "w_dlg_sl_collmaster_search_req.aspx", "?member=" + memberNoVal);
        ...
        function OnDwCollClicked(sender, rowNumber, buttonName) {
            ...
            if (buttonName == "b_delrow") {
                ...
                //ค้นหาหลักทรัพย์ค้ำประกัน memno
                var memberNoVal = objdw_main.GetItem(1, "member_no");
                Gcoop.OpenDlg(620, 250, "w_dlg_sl_collmaster_search_req.aspx", "?member=" + memberNoVal);
        ...
        function ItemDwOtherclrChanged(sender, rowNumber, columnName, newValue) {
            if (columnName == "clrother_amt") {
                ...
                objdw_otherclr.SetItem(rowNumber, "clrothertype_code", newValue);
                objdw_otherclr.AcceptText();
                if (newValue == "DFP") { jsSumclrotheramt(); }
        ...
        function GetValueFromDlgCollmast(collRefNo, collmast_desc, mortgage_price) {
            ...
            objdw_coll.SetItem(rowNumber, "use_amt", mortgage_price);
            // (mortgage_price * 90) / 100);
            Gcoop.GetEl("HUseamt").value = mortgage_price;  //(mortgage_price * 90) / 100;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <%-- <span style="cursor: pointer" onclick="OnClickLinkNext();">-พิมพ์เสัญญาเงินกู้</span>
    <br />
    <span style="cursor: pointer" onclick="OnclickLinkNextinvoice();">-พิมพ์ใบแจ้งการชำระหนี้-หุ้นพิเศษ
    </span>--%>
    <br />
    ...
    <br />
    <asp:CheckBox ID="Checkpension" runat="server" AutoPostBack="True" OnCheckedChanged="Checkedpension"
        Text="ไม่รับบำนาญ" Style="color: #000000; font-family: Tahoma; background-color: #0099CC" />
    <asp:CheckBox ID="Extenperiod" runat="server" AutoPostBack="True" OnCheckedChanged="Extendedperiod"
        Text="ขยายงวด" Style="color: #000000; font-family: Tahoma; background-color: #0099CC" />
    <asp:CheckBox ID="Checkshare" runat="server" AutoPostBack="True" OnCheckedChanged="Checkedshare"
        Text="ใช้หุ้นขยาย" Style="background-color: #FFCC00" />
    <%--  <asp:CheckBox ID="Checkperiod" runat="server" AutoPostBack="True" OnCheckedChanged="Checkedperoid"
        Text="ขยายงวด" style="font-family: Tahoma; background-color: #009900" />--%>
    <br />
    ...
    <asp:HiddenField ID="Hloantype_code" runat="server" />
</asp:Content>
