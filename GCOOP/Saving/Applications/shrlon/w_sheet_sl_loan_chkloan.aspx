<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_sl_loan_chkloan.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_chkloan" %>
        ...
        function OnDwCollClicked(sender, rowNumber, buttonName) {
            ...
            if (buttonName == "b_delrow") {
                ...
                if ((collNo != "") && (collNo != null)) {
                    ...
                    Gcoop.OpenDlg('700', '450', 'w_dlg_sl_loanrequest_coll.aspx', "?refCollNo=" + refCollNo + "&coop_id=" + coop_id + "&coll_amt=" + coll_amt + "&coll_use=" + coll_use + "&coll_blance=" + coll_blance + "&collType=" + collType + "&row=" + rowNumber);
                    return;
                }
                else {
               ...
               // Gcoop.OpenDlg('600', '450', 'w_dlg_dp_account_search.aspx', '');
                ...
                Gcoop.OpenDlg('600', '450', 'w_dlg_sl_collmaster_search_req.aspx', "?member=" + memberNoVal);
            }
