<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_requestment_dividen.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_dividen" %>
    ...
    <script type="text/javascript">
        ...
        function GetValueAccID(dept_no, deptaccount_name, prncbal) {
            ...
            if (colunmName == "b_searchc") {
                ...
                var rowNumber = Gcoop.GetEl("HdRowNumber").value;
                var itemtype_code = objdw_otherclr.GetItem(rowNumber, "clrothertype_code");
                if (itemtype_code == "DEP") {
                    objdw_otherclr.SetItem(1, "clrother_desc", dept_no);
