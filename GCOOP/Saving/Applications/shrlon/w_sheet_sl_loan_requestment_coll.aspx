<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_requestment_coll.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_coll" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <%=jsStartkeep%>
    <script type="text/javascript">
        ...
        function OnHaveColl() {
            var collNo = objdw_main.GetItem(1, "member_no");
            //  var requestDate = objdw_main.GetItem(1, "loanrequest_tdate");
            if ((collNo != "") && (collNo != null)) {
                jsSetDataList();
                var refCollNo = objdw_main.GetItem(1, "member_no");
                var coop_id = objdw_main.GetItem(1, "memcoop_id");
                var collType = "01";
                //alert(requestDate);
                Gcoop.OpenDlg('600', '450', 'w_dlg_sl_loanrequest_coll_me.aspx', "?refCollNo=" + refCollNo + "&coop_id=" + coop_id + "&collType=" + collType + "&row=" + 1);
                return;
            }
            else {
                alert("ไม่สามารถแสดงรายการได้ กรุณากรอกเลขที่อ้างอิงก่อน");
        ...
        function OnDwClearClicked(sender, rowNumber, objectName) {
            ...
            if (objectName == "clear_status") {
                ...
                //                alert(objdw_clear.GetItem(rowNumber, "clear_status") + "-" + rowNumber);
                //  Gcoop.CheckDw(sender, rowNumber, objectName, "clear_status", 1, 0);
                //  if (objdw_clear.GetItem(rowNumber, "clear_status") == 1) {
                jsSumOthClr();
                // } else { jsSumOthClrDelete(); }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <br />
     <asp:Literal ID="Ltcoll" runat="server"></asp:Literal>
      <asp:Literal ID="Ltcollremark" runat="server"></asp:Literal>
      <br />
    ...
    <span class="linkSpan" onclick="OnHaveColl()" style="font-size: small; color: Green;
        float: right">ผู้กู้ค้ำคนอื่น</span>
        ...
        <tr>
            <td>
                ...
                <dw:WebDataWindowControl ID="dw_otherclr" runat="server" DataWindowObject="d_sl_loanrequest_otherclr"
                    ...
                    BorderStyle="solid" BorderColor="white" TabIndex="300">
                </dw:WebDataWindowControl>
            </td>
            <td>
