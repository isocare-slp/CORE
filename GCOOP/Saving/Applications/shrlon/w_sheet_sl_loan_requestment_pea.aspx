<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_sl_loan_requestment_pea.aspx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_requestment_pea"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Validate_CheckCollamt() { //@PEA ประเภท 19 กับ 20 มีการนับสิทธิ์ค้ำ แต่ไม่นับวงเงินค้ำประกัน
