<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_slip_pay_ireport_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 770px;">
            ...
            <tr >
                <td>
                    <div>
                        <span style="visibility:<%=IsShow%>;">อ้างอิง:</span>
                    </div>
                </td>
                <td colspan="2">
                ...
                <td>
                    <div>
                        <span style="visibility:<%=IsShow%>;">จำนวน:</span>
                    </div>
                </td>
                <td colspan="2">
                    <asp:TextBox ID="ref_slipamt" runat="server" Style="text-align: right; width: 170px;" ToolTip="#,##0.00"  ></asp:TextBox>
                    <asp:Button ID="b_ref" runat="server" Text="..." Style="margin-right: 2px;
                            font-size: 16px; width: 20px;" Font-Bold="true " />
                </td>
                <td>
                    <div>
                        <span style="font-size: 12px; visibility:<%=IsShow%>;">กองทุน :</span>
                    </div>
                </td>
                <td>
                    <asp:TextBox ID="wrtfund" runat="server" Style="text-align: right;" ToolTip="#,##0.00"  ></asp:TextBox>
