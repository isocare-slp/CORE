<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="w_sheet_td_opr_iv.aspx.cs" Inherits="Saving.Applications.trading.w_sheet_td_opr_iv" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function jsAjaxDebt_no(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_opr_iv_ajax.aspx", "ajaxinitDebt_no", arg, initDebt_no);
        }
...
//                }
        ...
        function jsAjaxItemQty(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_opr_iv_ajax.aspx", "ajaxinitItemQty", arg, initItemQty);
        }
        ...
        function jsAjaxProduct(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_opr_iv_ajax.aspx", "ajaxinitDetail", arg, initRowDwDetail);
        }
