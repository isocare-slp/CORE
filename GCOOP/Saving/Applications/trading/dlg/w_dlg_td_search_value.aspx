<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_td_search_value.aspx.cs"
    Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_value" %>
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="d_td_search_value"
            LibraryList="~/DataWindow/trading/dlg_td_search_value.pbl" AutoRestoreContext="False"
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
