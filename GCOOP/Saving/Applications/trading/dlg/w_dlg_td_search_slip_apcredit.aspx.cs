...
{
    public partial class w_dlg_td_search_slip_apcredit : PageWebDialog, WebDialog
    {
        ...
        public void WebDialogLoadBegin()
        {
            ...
            try
            {
                HdCredNo.Value = Request["cred_no"].ToString().Trim();
            }
            catch
            {
                HdCredNo.Value = "";
        ...
        private void InitData()
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        SQL = SQLBegin + " and tddebtcredit.credittype_code = '" + HdCredittype_code.Value + "'";
                    }
                    if ((HdCredNo.Value).Trim() != "")
                    {
                        SQL = SQLBegin + " and tddebtcredit.debt_no = '" + HdCredNo.Value + "'";
                    }

  //                  SQL = SQL + " and tddebtcredit.debt_status = 8";
