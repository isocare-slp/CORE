<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_td_search_slip_apcredit.aspx.cs"
    Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_slip_apcredit" %>
    ...
    <script type="text/javascript">
        function onDwMainClick(s, r, c) {
            if (r > 0) {
                ...
                parent.GetDlgSlipNoApc(slip_no);
                parent.RemoveIFrame();
            }
        }
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwCri" runat="server" DataWindowObject="d_td_search_slip_cred_cri"
            LibraryList="~/DataWindow/trading/dlg_td_search_slip_apcredit.pbl" AutoRestoreContext="False"
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_tradesrv_fin_apcredit_listing"
            LibraryList="~/DataWindow/trading/dlg_td_search_slip_apcredit.pbl" AutoRestoreContext="False"
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
        ...
        <asp:HiddenField ID="HdCredNo" runat="server" Value="" />
