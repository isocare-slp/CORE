<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_td_search_memb.aspx.cs"
    Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_memb" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function DwDetailClick(s, r, c) {
            if (r > 0) {
                var member_no = objDwDetail.GetItem(r, "member_no");
                parent.GetDlgMemberNo(member_no);
                parent.RemoveIFrame();
            }
        }
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwCri" runat="server" DataWindowObject="d_dp_memb_search_cri"
            LibraryList="~/DataWindow/trading/dlg_td_search_memb.pbl" AutoRestoreContext="False"
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
            ClientEventButtonClicked="OnDwCriButtonClicked" ClientFormatting="True" TabIndex="1">
        </dw:WebDataWindowControl>
        <dw:WebDataWindowControl ID="DwDetail" runat="server" DataWindowObject="d_dp_memb_search"
            LibraryList="~/DataWindow/trading/dlg_td_search_memb.pbl" AutoRestoreContext="False"
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
