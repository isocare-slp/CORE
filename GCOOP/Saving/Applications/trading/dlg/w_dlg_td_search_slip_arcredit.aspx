<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_td_search_slip_arcredit.aspx.cs"
    Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_slip_arcredit" %>
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_tradesrv_fin_arcredit_listing"
            LibraryList="~/DataWindow/trading/dlg_td_search_slip_apcredit.pbl" AutoRestoreContext="False"
            AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
