<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_td_search_debtrecieve.aspx.cs" 
Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_debtrecieve" %>
...
<body>
    ...
    <div>
    <dw:WebDataWindowControl ID="DwCri" runat="server" DataWindowObject="d_td_search_debtrecieve_cri"
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_td_search_debtrecieve_listing"
                LibraryList="~/DataWindow/trading/dlg_td_search_recieve.pbl" AutoRestoreContext="False"
                AutoRestoreDataCache="True" AutoSaveDataCacheAfterRetrieve="True" ClientScriptable="True"
