...
CodeBehind="w_dlg_td_search_slip_store.aspx.cs" Inherits="Saving.Applications.trading.dlg.w_dlg_td_search_slip_store" %>
    ...
    <script type="text/javascript">
        function onDwMainClick(s, r, c) {
            if (r > 0) {
                ...
                parent.GetDlgSlipStore(slip_no);
                parent.RemoveIFrame();
            }
        }
...
<body>
    ...
    <div>
        ...
        <dw:WebDataWindowControl ID="DwCri" runat="server" DataWindowObject="d_search_slip_cri"
                LibraryList="~/DataWindow/trading/dlg_td_search_slip_store.pbl" AutoRestoreContext="False"
