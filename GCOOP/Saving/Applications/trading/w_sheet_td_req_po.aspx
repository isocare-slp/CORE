...
CodeBehind="w_sheet_td_req_po.aspx.cs" Inherits="Saving.Applications.trading.w_sheet_td_req_po" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('input[name="delivery_tdate_0"]').keyup(function () {
                ActiveChangeFormatDate('input[name="delivery_tdate_0"]');
            });

            $('input[name="due_tdate_0"]').keyup(function () {
                ActiveChangeFormatDate('input[name="due_tdate_0"]');
            });
        ...
        function delivery_tdateChange() {
            var CreditTerm = getObjFloat(objDwMain, 1, "credit_term");
            var delivery_tdate = objDwMain.GetItem(1, "delivery_tdate");
            var due_tdate = addDate(delivery_tdate, CreditTerm);
        ...
        function jsAjaxCredNo(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_req_po_ajax.aspx", "ajaxinitCred_no", arg, initCredno);
        }
        ...
        function jsAjaxDebt_no(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_req_po_ajax.aspx", "ajaxinitDebt_no", arg, initDebt_no);
        }
        ...
        function jsAjaxProduct(s, r, c, v) {
            ...
            ajax.PostbackPage("w_sheet_td_req_po_ajax.aspx", "ajaxinitDetail", arg, initRowDwDetail);
        }
        ...
        function jsAjaxItemQty(s, r, c, v) {
            ...
            Gcoop.GetEl("HdRowDwDetail").value = r + "";
            ajax.PostbackPage("w_sheet_td_req_po_ajax.aspx", "ajaxinitItemQty", arg, initItemQty);
        }
